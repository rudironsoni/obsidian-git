...
-   There is no WDIO or real-Obsidian GUI harness in this repository. Do not
    claim UI or runtime bugs are fixed from unit tests alone when the change
    is user-visible in Obsidian; say so if a check was skipped.
