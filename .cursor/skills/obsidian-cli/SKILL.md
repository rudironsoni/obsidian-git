---
name: obsidian-cli
description: Interactive Obsidian CLI loop for local plugin development. Use when a developer has desktop Obsidian running and wants to reload obsidian-git, capture errors, eval JS, screenshot, or inspect the DOM. Not a CI quality gate. Requires the official Obsidian CLI.
---
