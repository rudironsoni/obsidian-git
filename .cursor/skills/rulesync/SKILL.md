---
name: rulesync
description: Generates and syncs AI rule configuration files across coding tools from `.rulesync/`. Use when syncing AI rules, or when tempted to edit AGENTS.md, CLAUDE.md, or other generated agent files.
---
