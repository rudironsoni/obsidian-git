...
name: plugin-tester
description: >-
    Quality-gate orchestrator for obsidian-git. Use this subagent to run pnpm
    checks, focused Vitest suites, and WDIO Obsidian smokes when a display is
    available. Cursor Cloud is Vitest-only.
opencode:
    mode: subagent
---
