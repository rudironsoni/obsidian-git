...
### [3.0.3](https://github.com/rudironsoni/obsidian-git/compare/3.0.2...3.0.3) (2026-08-20)

### [3.0.2](https://github.com/rudironsoni/obsidian-git/compare/3.0.1...3.0.2) (2026-08-19)

### [3.0.1](https://github.com/rudironsoni/obsidian-git/compare/3.0.0...3.0.1) (2026-08-19)
...
* :construction: Add Git View, still WIP, issues with the Hover Preview ([53a3fc8](https://github.com/rudironsoni/obsidian-git/commit/53a3fc87ca2399fa76408b3c33c0ea02e16b3e77))
* :sparkles: Add "Open File in GitHub" Command, fix [#149](https://github.com/rudironsoni/obsidian-git/issues/149) ([2c216d0](https://github.com/rudironsoni/obsidian-git/commit/2c216d033fe0a82a68cf4951d72b5af4e9d10c87))
* :sparkles: Add Command to open file history on GitHub ([e7dd288](https://github.com/rudironsoni/obsidian-git/commit/e7dd288ba85a87e783d18c2b51e9027ec20f94fa))
* :sparkles: Add Diff View ([78cd43f](https://github.com/rudironsoni/obsidian-git/commit/78cd43fadece2b2d6bed80582bba18d842632e1a)), closes [#158](https://github.com/rudironsoni/obsidian-git/issues/158)
* :sparkles: Add Folder view to Sidebar ([919dc44](https://github.com/rudironsoni/obsidian-git/commit/919dc4435f08e8b3217ee66237a0671687bdb5a1)), closes [#134](https://github.com/rudironsoni/obsidian-git/issues/134)
* :sparkles: Allow multiline commit messages, fix [#157](https://github.com/rudironsoni/obsidian-git/issues/157) ([80ea17e](https://github.com/rudironsoni/obsidian-git/commit/80ea17e34f07f43bfe2aef1b5c520160a0e71e10))
* :sparkles: Finish the design of the Sidebar View ([ba9197b](https://github.com/rudironsoni/obsidian-git/commit/ba9197b8ee58e3f31a68a2c603a8531097e9cf93))
* `master` branch is no longer hardcoded ([dc8f3bd](https://github.com/rudironsoni/obsidian-git/commit/dc8f3bda9751a358fdd64771eec0c6b25bb07f6d))
* Add "Disable notifications" setting + some minor fixes ([ec240a7](https://github.com/rudironsoni/obsidian-git/commit/ec240a7122656e551b93a79ad5af9b7be138b2ec))
* add {{files}} template placeholder ([64adf0f](https://github.com/rudironsoni/obsidian-git/commit/64adf0f464cfdad544fec225e52798ccbb565d4d))
* add `{{numFiles}}` placeholder ([fbc6ce8](https://github.com/rudironsoni/obsidian-git/commit/fbc6ce85d4f6f2b183c7a41f9cbd8f2814027e92))
* Add an ability to pull changes from remote repository. ([88da6e5](https://github.com/rudironsoni/obsidian-git/commit/88da6e5bc01ef5066ab994e69640e0e101ed6b8f))
* add an ability to push changes to a remote repository ([f229516](https://github.com/rudironsoni/obsidian-git/commit/f2295165fbd77dd9ed6e4cdd2f6d085b3ee78bfe))
* Add an ability to specify custom commit message (specified in plugin settings) ([ca67112](https://github.com/rudironsoni/obsidian-git/commit/ca671124c5b2dc5127b76f48ab94e63d1e2b3626))
* Add an option to automatically fetch updates from remote repository when Obsidian starts ([aa59d29](https://github.com/rudironsoni/obsidian-git/commit/aa59d29fb23ac5b42d8c6a644fdc413a04931966))
* add auto backup after last change ([192a947](https://github.com/rudironsoni/obsidian-git/commit/192a9474af7fbd607d451c8b95afaa46c84b7a9d)), closes [#140](https://github.com/rudironsoni/obsidian-git/issues/140)
* Add autosave feature ([6f0d6bc](https://github.com/rudironsoni/obsidian-git/commit/6f0d6bc0b8b84fe6e14fcf1c85e6a6213c9da578))
* add backup button to source control view ([477b166](https://github.com/rudironsoni/obsidian-git/commit/477b16644dddd13dce1bde1600aed996b2b8f377)), closes [#374](https://github.com/rudironsoni/obsidian-git/issues/374)
* add commands for push and commit ([82dd037](https://github.com/rudironsoni/obsidian-git/commit/82dd037189a4dbe1b8ef7cad13d0c11b0817af2d)), closes [#122](https://github.com/rudironsoni/obsidian-git/issues/122)
* add commit amend command ([8f10261](https://github.com/rudironsoni/obsidian-git/commit/8f10261b08a498b0fc8f989209c1e0b048a27c35)), closes [#648](https://github.com/rudironsoni/obsidian-git/issues/648)
* add context menu to git views ([115c4ba](https://github.com/rudironsoni/obsidian-git/commit/115c4baccaaf0e905fa8eefee8cb5f35abfff88f)), closes [#615](https://github.com/rudironsoni/obsidian-git/issues/615)
* add custom commit message to auto backup ([b3d8077](https://github.com/rudironsoni/obsidian-git/commit/b3d8077bab29edf2602cd57a392969abf89e4241)), closes [#135](https://github.com/rudironsoni/obsidian-git/issues/135)
* add delete repo command ([26cdfb8](https://github.com/rudironsoni/obsidian-git/commit/26cdfb8629f2909e019fecebecd6ff745ad0b932))
* add env var OBSIDIAN_GIT for scripting ([2b76097](https://github.com/rudironsoni/obsidian-git/commit/2b7609774cfd8689297c23ea672264cea6255409))
* add fetch command ([222245b](https://github.com/rudironsoni/obsidian-git/commit/222245b7c750bd4d2740aa25913d74d538e5035d))
* add file name to diff view tab name ([8520c2b](https://github.com/rudironsoni/obsidian-git/commit/8520c2beed20f9fe20e6af830c34f59b1678b36a))
* add git initialization and conflict files status to statusbar ([ba0ef11](https://github.com/rudironsoni/obsidian-git/commit/ba0ef11a5abcc8ff11d9e33ca8157a283d06920b))
* add hidden commit staged command ([234bf8f](https://github.com/rudironsoni/obsidian-git/commit/234bf8f97e767b2523c74dc336a2c690b9d231b9)), closes [#932](https://github.com/rudironsoni/obsidian-git/issues/932)
* add hostname commit message placeholder ([32d8382](https://github.com/rudironsoni/obsidian-git/commit/32d8382c804b1e86effb409246dad06cad78506d)), closes [#146](https://github.com/rudironsoni/obsidian-git/issues/146)
* add instructions to conflict  file ([50291d3](https://github.com/rudironsoni/obsidian-git/commit/50291d3b182ba4789dac25164ca66f511ba1ab67)), closes [#402](https://github.com/rudironsoni/obsidian-git/issues/402)
* add mobile support for history view ([8472c90](https://github.com/rudironsoni/obsidian-git/commit/8472c9004779ae143eb1208999b82d2a676e6b37))
* add more granular customization of `{{date}}` commit message placeholder ([7063f5a](https://github.com/rudironsoni/obsidian-git/commit/7063f5a902c3141671ddbf3c82c2076e07cc872b))
* add option to disable status bar ([0ab55d3](https://github.com/rudironsoni/obsidian-git/commit/0ab55d3f0805a031e9e3ec5b5cfa21d8c5026330)), closes [#70](https://github.com/rudironsoni/obsidian-git/issues/70)
* add option to squash unpushed commits before push ([#1104](https://github.com/rudironsoni/obsidian-git/issues/1104)) ([767a665](https://github.com/rudironsoni/obsidian-git/commit/767a66555bc7ad3a47bb74078a156c10cdd1a664))
* add progress events no desktop ([d755aba](https://github.com/rudironsoni/obsidian-git/commit/d755aba7bd3263ea451cfe7591b7eea6a72b4898))
* add progress to push and clone ([110b6ba](https://github.com/rudironsoni/obsidian-git/commit/110b6baca8649f3c04b5f2b9d787f22bc78fbb18))
* add rebase option for pull ([b04e444](https://github.com/rudironsoni/obsidian-git/commit/b04e444e99ca31d1abb1e4bfdd81cbdaca88caec)), closes [#155](https://github.com/rudironsoni/obsidian-git/issues/155)
* add remote editing ([f70363b](https://github.com/rudironsoni/obsidian-git/commit/f70363b522c2e144260411d01e26108f7dedb735))
* add setting for auto-pull on backup ([5c39e0d](https://github.com/rudironsoni/obsidian-git/commit/5c39e0d320615cfb73cdb414088e3a02a74e9faf))
* add setting to disable 'No changes...' popups ([#676](https://github.com/rudironsoni/obsidian-git/issues/676)) ([bfd6de9](https://github.com/rudironsoni/obsidian-git/commit/bfd6de9092aaa18d7624b374d10873a179f12351))
* add setting to hide error notifications ([54f0541](https://github.com/rudironsoni/obsidian-git/commit/54f0541296d910dba317f4f83cf0fbbc1702a596)), closes [#870](https://github.com/rudironsoni/obsidian-git/issues/870)
* add setting to hide file menu actions ([a59d38a](https://github.com/rudironsoni/obsidian-git/commit/a59d38a9f00042a1c27dc64426cd93e595f8eb6b)), closes [#456](https://github.com/rudironsoni/obsidian-git/issues/456)
* add settings pane icon ([5ea08b8](https://github.com/rudironsoni/obsidian-git/commit/5ea08b874e2bfdc532e8e351921a4a3d97ff41bb))
* add show, diff, log as api ([b3a72a4](https://github.com/rudironsoni/obsidian-git/commit/b3a72a46dfb917b28ca9af7848994668d1846b64))
* Add status bar that shows status updates ([80dbf0f](https://github.com/rudironsoni/obsidian-git/commit/80dbf0f647fe27237bd86174feebe7987a90be63))
* add submodules support ([2a4ce6d](https://github.com/rudironsoni/obsidian-git/commit/2a4ce6d47696cd6667b639c8479b37f61346e9be)), closes [#93](https://github.com/rudironsoni/obsidian-git/issues/93)
* add to .gitignore command ([c824903](https://github.com/rudironsoni/obsidian-git/commit/c824903ea8572619b147b405dee76e51b4970f9c))
* Add toggle in Settings to choose default layout ([38c7240](https://github.com/rudironsoni/obsidian-git/commit/38c7240918d1e463044431d976b9025eb1fdc318))
* add unstage to git view ([0e27a40](https://github.com/rudironsoni/obsidian-git/commit/0e27a40b13a519a20e47095c1fc439ddca16542c))
* additional environment variables ([f9b1bca](https://github.com/rudironsoni/obsidian-git/commit/f9b1bca38c6db23f05abfb211933f7ce4f69db7f)), closes [#414](https://github.com/rudironsoni/obsidian-git/issues/414)
* allow empty default manual commit message ([#1022](https://github.com/rudironsoni/obsidian-git/issues/1022)) ([20c942e](https://github.com/rudironsoni/obsidian-git/commit/20c942e4780e9ed272c92824f89b703dd59f53db))
* allow specifying `{{date}}` placeholder in commit message ([43c5f6e](https://github.com/rudironsoni/obsidian-git/commit/43c5f6e509d1284411ff26332b7820710fd51c2f))
* append .git to https remote url if not present ([2aca7c8](https://github.com/rudironsoni/obsidian-git/commit/2aca7c85b40792f619c511206375f224ece5ab27)), closes [#867](https://github.com/rudironsoni/obsidian-git/issues/867)
* auto commit only staged files ([e64ef60](https://github.com/rudironsoni/obsidian-git/commit/e64ef60406c52729f5105887f27e9db10a9e4cb2)), closes [#927](https://github.com/rudironsoni/obsidian-git/issues/927)
* auto pull on specified interval ([2aa7fb8](https://github.com/rudironsoni/obsidian-git/commit/2aa7fb866e41c1f7170b723a35d9acd2942921b0)), closes [#59](https://github.com/rudironsoni/obsidian-git/issues/59)
* auto pull/backup outlives session ([7ec00e7](https://github.com/rudironsoni/obsidian-git/commit/7ec00e7cfd113aeb827f282d765ca061d85235a6)), closes [#68](https://github.com/rudironsoni/obsidian-git/issues/68)
* branch management ([caaacd1](https://github.com/rudironsoni/obsidian-git/commit/caaacd11c8634e86b01dc19dfb57b546adedf7e6)), closes [#132](https://github.com/rudironsoni/obsidian-git/issues/132) [#220](https://github.com/rudironsoni/obsidian-git/issues/220)
* buttons for hunk actions and display on click ([a3dcd02](https://github.com/rudironsoni/obsidian-git/commit/a3dcd02fba27afc895968af6df6e752c5f06842f))
* cache status for commit ([846c1fe](https://github.com/rudironsoni/obsidian-git/commit/846c1fee9052c8d446ec169fba38b5c541669809))
* check for too big files ([f0f3942](https://github.com/rudironsoni/obsidian-git/commit/f0f394246fb001dcd4b5b42f17d764f7a95a4486)), closes [#248](https://github.com/rudironsoni/obsidian-git/issues/248) [#189](https://github.com/rudironsoni/obsidian-git/issues/189)
* close hunk preview with escape key ([fd9bef8](https://github.com/rudironsoni/obsidian-git/commit/fd9bef871ceed52834cae41add670ed5d59420b5)), closes [#1027](https://github.com/rudironsoni/obsidian-git/issues/1027)
* collapse unchanged lines in split diff view ([#893](https://github.com/rudironsoni/obsidian-git/issues/893)) ([6377157](https://github.com/rudironsoni/obsidian-git/commit/637715747deb465ca0730d273002679b8bde5540))
* combine multiple empty directory into one in git view ([4e45e6a](https://github.com/rudironsoni/obsidian-git/commit/4e45e6accc468402033c5b56d6fb56ec5b461c1e))
* command to backup and close Obsidian ([c144d80](https://github.com/rudironsoni/obsidian-git/commit/c144d80e719fae5d3aba6f0ff5535172993a2c69)), closes [#13](https://github.com/rudironsoni/obsidian-git/issues/13)
* command to preview hunk ([7f26cfe](https://github.com/rudironsoni/obsidian-git/commit/7f26cfe131b6ec47c2c361d510855a19a412bcaf))
* commit changes with specified message (close [#26](https://github.com/rudironsoni/obsidian-git/issues/26)) ([e992199](https://github.com/rudironsoni/obsidian-git/commit/e9921994e135ac01f5eda8f23d7c4db312cedd05))
* commit message from script ([c05f847](https://github.com/rudironsoni/obsidian-git/commit/c05f847baac1cfa121755bd6a10cfc5316a8f680)), closes [#849](https://github.com/rudironsoni/obsidian-git/issues/849)
* commit only staged files ([f6f4a97](https://github.com/rudironsoni/obsidian-git/commit/f6f4a97c36acda5950bb156f1732ab0ece89a63e))
* conflict files support ([358dc6e](https://github.com/rudironsoni/obsidian-git/commit/358dc6e492e6ef8156687535d14a9070ebadfb30)), closes [#38](https://github.com/rudironsoni/obsidian-git/issues/38)
* context menu with copy and paste in split diff view ([9f752d9](https://github.com/rudironsoni/obsidian-git/commit/9f752d9ee5ef541ca144fc048b5410d06895bff2)), closes [#1153](https://github.com/rudironsoni/obsidian-git/issues/1153)
* ctrl + enter to commit-and-sync ([e15cdc0](https://github.com/rudironsoni/obsidian-git/commit/e15cdc06eaa9a1b33f39535621fd6ee873cd27e0)), closes [#901](https://github.com/rudironsoni/obsidian-git/issues/901)
* custom git repository root ([#209](https://github.com/rudironsoni/obsidian-git/issues/209)) ([4157e42](https://github.com/rudironsoni/obsidian-git/commit/4157e42fa6cbd0f69d8ed03169c5bc836229d6d4))
* custom GIT_DIR ([978453e](https://github.com/rudironsoni/obsidian-git/commit/978453ebb1cf0df1c70bd169665709cd512264dd))
* custom PATH env paths ([2c42609](https://github.com/rudironsoni/obsidian-git/commit/2c4260942a738421bf517f1b0d063b536345f8bf))
* Default {{hostname}} placeholder to OS hostname when not explicitly configured ([#1044](https://github.com/rudironsoni/obsidian-git/issues/1044)) ([1cc045d](https://github.com/rudironsoni/obsidian-git/commit/1cc045dbc2a93b33d6c0ef02e6752a889685efdd))
* diff view on mobile ([86b4d5a](https://github.com/rudironsoni/obsidian-git/commit/86b4d5ad4be23b420fe0efd0f3dfd989047be23a)), closes [#302](https://github.com/rudironsoni/obsidian-git/issues/302)
* different intervals for commit and push ([59367aa](https://github.com/rudironsoni/obsidian-git/commit/59367aa3d0fde912cf393f5e48989758f44b82e0)), closes [#106](https://github.com/rudironsoni/obsidian-git/issues/106)
* disable plugin per device ([82b2c1a](https://github.com/rudironsoni/obsidian-git/commit/82b2c1ad82196927eda16b965094f025a1ed2960)), closes [#301](https://github.com/rudironsoni/obsidian-git/issues/301)
* discard all changes ([3461a30](https://github.com/rudironsoni/obsidian-git/commit/3461a300ee563a316faf5d198473f2ccc323b1e8))
* discard directories ([149805f](https://github.com/rudironsoni/obsidian-git/commit/149805f24e310e2b225be904c75094b90d38dd33))
* display hunk changes inline ([f346cac](https://github.com/rudironsoni/obsidian-git/commit/f346cac94199b0a97fda8c8d7908765c075d6109))
* display messages in status bar (including error ones) ([b51dd92](https://github.com/rudironsoni/obsidian-git/commit/b51dd929f04bdae8cdc84c85110eeffde59dedb6)), closes [#4](https://github.com/rudironsoni/obsidian-git/issues/4) [#5](https://github.com/rudironsoni/obsidian-git/issues/5)
* edit .gitignore ([1cad1b7](https://github.com/rudironsoni/obsidian-git/commit/1cad1b72649c4ad7da931a32bb891176e2f96b3d))
* fix clone overwrite ([d853a4e](https://github.com/rudironsoni/obsidian-git/commit/d853a4ea00f636bcf98a3e5c31ad360923f30219))
* go to prev/next hunk commands ([48d6658](https://github.com/rudironsoni/obsidian-git/commit/48d66580564fd4105291cdae56180d7e005a080a))
* granular settings and change status bar ([29bd5ae](https://github.com/rudironsoni/obsidian-git/commit/29bd5ae0ff916b33b43bff028340ee476ad7b81c))
* hide settings when git is not ready ([4c40556](https://github.com/rudironsoni/obsidian-git/commit/4c40556653132767d1dd424fa37c75ccf7cafe86))
* highlight opened diff view file ([5708c63](https://github.com/rudironsoni/obsidian-git/commit/5708c63ad7cad72c3939a4d554a5b98bc04783ed)), closes [#545](https://github.com/rudironsoni/obsidian-git/issues/545)
* hunk actions ([1c32ceb](https://github.com/rudironsoni/obsidian-git/commit/1c32ceb038f112c674ed102dc78bf36a2c7018cf))
* if Git is not found in PATH on windows try default location ([4301e31](https://github.com/rudironsoni/obsidian-git/commit/4301e31b2b66e111826e900e2d0942e0de871c74)), closes [#489](https://github.com/rudironsoni/obsidian-git/issues/489)
* improve discard modal ([872fc18](https://github.com/rudironsoni/obsidian-git/commit/872fc182743df108a42ae244699bb2d2b03d7c69))
* improve source control view style ([d5647a8](https://github.com/rudironsoni/obsidian-git/commit/d5647a8e2e49c8a77f28854bb4c276a17f390d55))
* Improve UX a bit by showing notification of what's happening when user presses hotkey ([c562e74](https://github.com/rudironsoni/obsidian-git/commit/c562e746d7538923a378104d0204dad1f3f2aa61))
* include old file name in log ([fa34fb5](https://github.com/rudironsoni/obsidian-git/commit/fa34fb5c87c9d9d6b294ef3fe28f5c7538df21ac))
* Line Authoring ([aa8dd1b](https://github.com/rudironsoni/obsidian-git/commit/aa8dd1b3cf0fc440c4d7177831795f3fc5b0076c)), closes [#321](https://github.com/rudironsoni/obsidian-git/issues/321)
* list changed files ([5e28b94](https://github.com/rudironsoni/obsidian-git/commit/5e28b9449f3f7f978fe825fb102b61fb27d191e4))
* list filenames affected by commit in the commit body ([0ce9ac3](https://github.com/rudironsoni/obsidian-git/commit/0ce9ac310c402a3a7a679fc30e591a045d3a4fb2)), closes [#3](https://github.com/rudironsoni/obsidian-git/issues/3)
* log git commands ([a63bb8a](https://github.com/rudironsoni/obsidian-git/commit/a63bb8a0063b69cc020a0fd0017b42d7ee31ed1e))
* make commit command and commit button in source control 'smart' ([f03d75e](https://github.com/rudironsoni/obsidian-git/commit/f03d75e5f9d239d89e7770dfe86c21e9aa7db632)), closes [#907](https://github.com/rudironsoni/obsidian-git/issues/907)
* mark push button when push is ready ([32936eb](https://github.com/rudironsoni/obsidian-git/commit/32936eb76dff45c2333660791faa0bc8f86e1154)), closes [#557](https://github.com/rudironsoni/obsidian-git/issues/557)
* merge conflicts ([14eb538](https://github.com/rudironsoni/obsidian-git/commit/14eb538d8fa01198bb9e944b0f01c7e1c04945a2))
* mobile support ([9ffda76](https://github.com/rudironsoni/obsidian-git/commit/9ffda762dbc0cba380942acdeabcb66adce8253d)), closes [#57](https://github.com/rudironsoni/obsidian-git/issues/57)
* new discard icon ([730e9a6](https://github.com/rudironsoni/obsidian-git/commit/730e9a6405b4018dc987b29c0a156feb01b583f2))
* notice when getting status ([c743092](https://github.com/rudironsoni/obsidian-git/commit/c7430926ec4dc8d3e827f7898a962984c9ac4009))
* offline mode ([6989ba4](https://github.com/rudironsoni/obsidian-git/commit/6989ba4fd7ce44bfac5c6f7479cf41ef8fcb5de3)), closes [#211](https://github.com/rudironsoni/obsidian-git/issues/211)
* open not supported files in changed files modal in default app ([93930e0](https://github.com/rudironsoni/obsidian-git/commit/93930e079384d0ae2ed165e94241dc1d0acee82a))
* open source control view with ribbon button ([dea4d6f](https://github.com/rudironsoni/obsidian-git/commit/dea4d6f915492ecc3d43b259fbe8764b9c6210a4))
* open/diff for log element ([26c6ef4](https://github.com/rudironsoni/obsidian-git/commit/26c6ef4f69a80640200b9e5be1c884bbfd5f089c))
* pause automatics via command ([f6f650e](https://github.com/rudironsoni/obsidian-git/commit/f6f650e4e85337f8e1613255899f191c12989f38))
* prefill edit remote modal ([223193c](https://github.com/rudironsoni/obsidian-git/commit/223193c51b362788a0682dc598c7d0eefa9ccdf0))
* progressbar on fetch ([2fe8d3a](https://github.com/rudironsoni/obsidian-git/commit/2fe8d3a0a47ea85176288145dd319776f74392ab))
* provide a GIT_ASKPASS handler via Obsidian modal ([1a788b0](https://github.com/rudironsoni/obsidian-git/commit/1a788b01af7cab7ad6d5a850f68a905ec680a2d2))
* pull before push (close [#43](https://github.com/rudironsoni/obsidian-git/issues/43)) ([30d8798](https://github.com/rudironsoni/obsidian-git/commit/30d8798d433f080404bd22c8a33a1ea49b37648f))
* pull on commit-and-sync even if no commit happened ([263e675](https://github.com/rudironsoni/obsidian-git/commit/263e675ead38fba8a7d5a5f3349830477817ca25)), closes [#787](https://github.com/rudironsoni/obsidian-git/issues/787)
* redesign source control view ([06f3c22](https://github.com/rudironsoni/obsidian-git/commit/06f3c229cfd199c716401ad1f4e524e2e23bc4f7))
* reload settings on file change ([d453c6f](https://github.com/rudironsoni/obsidian-git/commit/d453c6fe85143b6afcd672e3fd65ef7851dd9ae3)), closes [#779](https://github.com/rudironsoni/obsidian-git/issues/779)
* rename "Autosave" to "Vault backup interval" ([26cd1e3](https://github.com/rudironsoni/obsidian-git/commit/26cd1e371ad5b7076ac1da7575983ba4f6791713))
* rename backup to commit-and-sync and better settings page ([cd9ffc2](https://github.com/rudironsoni/obsidian-git/commit/cd9ffc2ebe964dc59c8ce5d114f444222eb1d068))
* respect push.autoSetupRemote config ([bde2b3d](https://github.com/rudironsoni/obsidian-git/commit/bde2b3df909e4557e15591d6def20a80e15cec40)), closes [#1020](https://github.com/rudironsoni/obsidian-git/issues/1020)
* reworked diff view handling ([be4856b](https://github.com/rudironsoni/obsidian-git/commit/be4856b0f3a6ecc7f4416f98d9eb05a992b61443)), closes [#202](https://github.com/rudironsoni/obsidian-git/issues/202) [#203](https://github.com/rudironsoni/obsidian-git/issues/203)
* run raw git commands ([d05b99c](https://github.com/rudironsoni/obsidian-git/commit/d05b99ca827b630e1c96fdb2a4dc19469b0b9b81))
* separate commit message for auto backup ([b59db5d](https://github.com/rudironsoni/obsidian-git/commit/b59db5dc816479fd6dad5d798d0979c49c8b8ccf)), closes [#197](https://github.com/rudironsoni/obsidian-git/issues/197)
* set author info as html attribute in line author information ([fad0dae](https://github.com/rudironsoni/obsidian-git/commit/fad0dae28391cba62744103165ddf0a909fa1014)), closes [#1017](https://github.com/rudironsoni/obsidian-git/issues/1017)
* set author to config ([f40920d](https://github.com/rudironsoni/obsidian-git/commit/f40920d9970dcdf6146b9b108b76cad88d166fdc))
* set last auto backup to last commit ([d8cfbf2](https://github.com/rudironsoni/obsidian-git/commit/d8cfbf2efe31770f6fd7ac6399bb7563f3caa831)), closes [#73](https://github.com/rudironsoni/obsidian-git/issues/73)
* show a mini file menu for hidden files from source control ([d2991cc](https://github.com/rudironsoni/obsidian-git/commit/d2991ccedcd59c56e685c2c776159f236bad8331)), closes [#766](https://github.com/rudironsoni/obsidian-git/issues/766)
* show changes files count in status bar ([d091694](https://github.com/rudironsoni/obsidian-git/commit/d0916947546aad84f506f39f9f754a6b3c33f42c)), closes [#243](https://github.com/rudironsoni/obsidian-git/issues/243)
* show commit summary as tooltip in line author information ([8746e4a](https://github.com/rudironsoni/obsidian-git/commit/8746e4a4f9591a0f83c42d71b1cdb44911364f80))
* show date and author in history view ([a6e33d3](https://github.com/rudironsoni/obsidian-git/commit/a6e33d30d1556c485cc2ac6467972aa471b94758)), closes [#691](https://github.com/rudironsoni/obsidian-git/issues/691)
* show last commit time in status bar ([4525fef](https://github.com/rudironsoni/obsidian-git/commit/4525fef302c23b54c233186bdbf898615fc1b314)), closes [#334](https://github.com/rudironsoni/obsidian-git/issues/334)
* show last commit time in status bar ([b6d93a1](https://github.com/rudironsoni/obsidian-git/commit/b6d93a1b8574b1d9dc56c3be9bf8403d95fcef26)), closes [#334](https://github.com/rudironsoni/obsidian-git/issues/334)
* specify depth on clone ([cf81f0c](https://github.com/rudironsoni/obsidian-git/commit/cf81f0c1ea72931b2274265e32ab4db2d11d0c82)), closes [#307](https://github.com/rudironsoni/obsidian-git/issues/307)
* specify merge strategy in settings ([#934](https://github.com/rudironsoni/obsidian-git/issues/934)) ([d64e4d7](https://github.com/rudironsoni/obsidian-git/commit/d64e4d7dfa57a7f5fb2073f9ebaaa2643acefdf8))
* specify source control refresh timer ([a1ecb1b](https://github.com/rudironsoni/obsidian-git/commit/a1ecb1b39954422de150169a71d0b9da8ee84167)), closes [#199](https://github.com/rudironsoni/obsidian-git/issues/199)
* split diff view ([8c8551f](https://github.com/rudironsoni/obsidian-git/commit/8c8551f05a2cdbc3f389097e870718ecaf04ff0a))
* stage and unstage current file ([f014e52](https://github.com/rudironsoni/obsidian-git/commit/f014e52e11cbb345a313914a9e71e0807a0d4197)), closes [#265](https://github.com/rudironsoni/obsidian-git/issues/265)
* stage and unstage to context menu ([081ad1d](https://github.com/rudironsoni/obsidian-git/commit/081ad1dda58f6ae8a3458bf8568de5165824410d))
* stage hunk ([5f0a5a2](https://github.com/rudironsoni/obsidian-git/commit/5f0a5a2344b2d390e0da300f50ed88d0221ec1f6))
* stage individual hunks from split diff view ([47e97c9](https://github.com/rudironsoni/obsidian-git/commit/47e97c9911655227de401d4da8eccbc160040f95))
* stage/unstage button on category ([3373e6d](https://github.com/rudironsoni/obsidian-git/commit/3373e6d0ee4f2a4d84e7b3513fd7712046b2e889))
* stage/unstage directory ([61b3eb3](https://github.com/rudironsoni/obsidian-git/commit/61b3eb3ac38553ef4cda0512be19b1f4480d613c))
* store git binary path in localstorage ([bd8bafc](https://github.com/rudironsoni/obsidian-git/commit/bd8bafc904e0f14501a9985c0ae490bea98297be)), closes [#283](https://github.com/rudironsoni/obsidian-git/issues/283)
* support cloning remote repos ([ab5ece7](https://github.com/rudironsoni/obsidian-git/commit/ab5ece75ceba3af5845770dc029732d5657720a3))
* support custom git binary path ([7793035](https://github.com/rudironsoni/obsidian-git/commit/77930351622a86ef3babdb4d60acbc8ff334cc84)), closes [#113](https://github.com/rudironsoni/obsidian-git/issues/113)
* support initalizing a new repo ([0fd2062](https://github.com/rudironsoni/obsidian-git/commit/0fd20627c3c289a05e0aba179b36badfe11d2414))
* support selecting upstream branch ([013878e](https://github.com/rudironsoni/obsidian-git/commit/013878e378bdbc6bab23c94615fba0c2bb72e1dc))
* two build options ([a3db9f3](https://github.com/rudironsoni/obsidian-git/commit/a3db9f370602ae4685eb23e1f5ebd7bc09f6338d))
* use icons for status bar ([96dcbc4](https://github.com/rudironsoni/obsidian-git/commit/96dcbc443369803a6f11d69ca80f34176025864a)), closes [#147](https://github.com/rudironsoni/obsidian-git/issues/147)


### Bug Fixes

* :adhesive_bandage: More specific CSS selectors for the diff-view ([c0c9a38](https://github.com/rudironsoni/obsidian-git/commit/c0c9a381f2c4c0527674e4e215e2418c71d68b73))
* :bug: Fix RegEx for openInGitHub ([ca59a2d](https://github.com/rudironsoni/obsidian-git/commit/ca59a2db581643cfd77f3663850fe1243efe4260))
* :children_crossing: Show diff on double click ([407dcc0](https://github.com/rudironsoni/obsidian-git/commit/407dcc05d6e9679c7487c1d2dfa78f580c16b5da))
* abort edit remotes on no url ([e617278](https://github.com/rudironsoni/obsidian-git/commit/e617278e68019583b39ac961de27fe84d46f572a))
* add additional author check ([58ce847](https://github.com/rudironsoni/obsidian-git/commit/58ce84749936c78a2789f3eae1e2de3877350b96))
* add guards and notifications for no current branch ([e5869a3](https://github.com/rudironsoni/obsidian-git/commit/e5869a3bce0ac1f33450f3bf8584904c9ea1f38e))
* add missing packages and remove import ([4434772](https://github.com/rudironsoni/obsidian-git/commit/44347725f6e97dfd12d2f5a64c9750edc36087ad))
* add missing simple-git unsafe setting ([d5534da](https://github.com/rudironsoni/obsidian-git/commit/d5534dad695698b40fc4f03be13bb36094cc14c6)), closes [#1067](https://github.com/rudironsoni/obsidian-git/issues/1067)
* add obsidian_askpass.sh to .git/info/exclude ([655d171](https://github.com/rudironsoni/obsidian-git/commit/655d1718da42a7eacce8e9a8b066c57304c512bb)), closes [#903](https://github.com/rudironsoni/obsidian-git/issues/903)
* add progress option before separating -- ([a35a19f](https://github.com/rudironsoni/obsidian-git/commit/a35a19f7ab51e16c4182c6380ee8f4e9f91a0479))
* add progress to checkout in pull ([2bce927](https://github.com/rudironsoni/obsidian-git/commit/2bce927ae8ab40372b2c217a9ae57b37fd390340))
* add promise queue ([f95d71a](https://github.com/rudironsoni/obsidian-git/commit/f95d71a5475107dbf1bbacfb3bdb4e74fd190d15)), closes [#61](https://github.com/rudironsoni/obsidian-git/issues/61)
* add remote on mobile ([c529a37](https://github.com/rudironsoni/obsidian-git/commit/c529a377195fea76028b424d5973aae80498670e)), closes [#375](https://github.com/rudironsoni/obsidian-git/issues/375)
* add vault_path ([e15d353](https://github.com/rudironsoni/obsidian-git/commit/e15d3533e1b21231569ac6dcd432749105730556))
* Adjust git.cwd to use a relative path to git root ([#733](https://github.com/rudironsoni/obsidian-git/issues/733)) ([ed31553](https://github.com/rudironsoni/obsidian-git/commit/ed31553a8cf25548ab722c4edf40d8d0a20df4e8))
* align buttons ([a09bc4a](https://github.com/rudironsoni/obsidian-git/commit/a09bc4ac2b5165b11a740230db55a4ef05e3c219))
* align font size in unified diff with Obsidian ([99b2522](https://github.com/rudironsoni/obsidian-git/commit/99b25224a0a38b2a9885ddada7bad6774e70cd7f)), closes [#1008](https://github.com/rudironsoni/obsidian-git/issues/1008)
* align signs properly with different line heights ([5bdf09c](https://github.com/rudironsoni/obsidian-git/commit/5bdf09c464d25e6dfb8b685f64c2a3c5af901f79))
* allow clone in current directory ([8f61a1a](https://github.com/rudironsoni/obsidian-git/commit/8f61a1a921c6df11953293f6d290eadf827ffee2))
* Allow commiting of files large than 100mb if handled by LFS ([#822](https://github.com/rudironsoni/obsidian-git/issues/822)) ([e67928d](https://github.com/rudironsoni/obsidian-git/commit/e67928db625a57405f0fa1711e9e031f0e89a683))
* allow different ssh remote user than git ([5b6400c](https://github.com/rudironsoni/obsidian-git/commit/5b6400cc85c827bc13e11ffa1bc0cbb3bd6cfd26)), closes [#664](https://github.com/rudironsoni/obsidian-git/issues/664)
* allow empty commit in history view ([2571473](https://github.com/rudironsoni/obsidian-git/commit/257147311cf65a2b5dedf957f4c71ad9624ce7be))
* allow empty in general modal ([43f282e](https://github.com/rudironsoni/obsidian-git/commit/43f282e8b9c8b86c7404f3375efd3d7ff9ca4642))
* ask for upstream branch in backup ([d1143f7](https://github.com/rudironsoni/obsidian-git/commit/d1143f7d643581ddf674b492921bf0aab9044643))
* author ([02ed605](https://github.com/rudironsoni/obsidian-git/commit/02ed605357a5109ce46d7fcb88fa75bdb0e43b8b))
* automatically refresh source control ([9c2b063](https://github.com/rudironsoni/obsidian-git/commit/9c2b063584366226da876c9e5e6509868b6a01cd)), closes [#199](https://github.com/rudironsoni/obsidian-git/issues/199)
* **automatics:** prevent rescheduling auto runs when plugin is unload… ([#1122](https://github.com/rudironsoni/obsidian-git/issues/1122)) ([b62f220](https://github.com/rudironsoni/obsidian-git/commit/b62f22067ecc65e68340ec348a86f675b31536b1))
* **auto:** prevent immediate sync on startup when last backup time is missing ([#1114](https://github.com/rudironsoni/obsidian-git/issues/1114)) ([e883ed5](https://github.com/rudironsoni/obsidian-git/commit/e883ed5e11217c932d7363bde7f46d53066d0db1))
* avoid misleading "Committed 0 files" notice ([#1103](https://github.com/rudironsoni/obsidian-git/issues/1103)) ([be21cdf](https://github.com/rudironsoni/obsidian-git/commit/be21cdfed623beb63d658a99a5659d669dee0d2e))
* backup with reset sync method ([41a00ff](https://github.com/rudironsoni/obsidian-git/commit/41a00ff8b17212a23c515d0f19be69a0b8d2f1c1)), closes [#319](https://github.com/rudironsoni/obsidian-git/issues/319)
* base path and remotes ([5aa7e8d](https://github.com/rudironsoni/obsidian-git/commit/5aa7e8df46e3216bce748ca4a29b5b08c6180766))
* better automatic backup/pull description ([10c3072](https://github.com/rudironsoni/obsidian-git/commit/10c307228da5c79cf62acfa2d6c90d2f519855a8)), closes [#181](https://github.com/rudironsoni/obsidian-git/issues/181)
* better error message for missing author ([2e9e3b1](https://github.com/rudironsoni/obsidian-git/commit/2e9e3b135de411f764ba6eef5b0aaf4d21216b55))
* binary writes in mobile git adapter ([#1090](https://github.com/rudironsoni/obsidian-git/issues/1090)) ([fea3659](https://github.com/rudironsoni/obsidian-git/commit/fea3659ce1305641a1fabbbd5f24c10cffc42377))
* cache ctime ([0041232](https://github.com/rudironsoni/obsidian-git/commit/00412320e995837aa0210b0a3a4b6c4d16791759))
* can push ([bfb05d0](https://github.com/rudironsoni/obsidian-git/commit/bfb05d02f586baca82972ac25225f10da52c6625))
* canPush ([5415ff5](https://github.com/rudironsoni/obsidian-git/commit/5415ff5b4b8028637d761f43945ad2195241ce32))
* catch aborted clone depth modal ([d11579c](https://github.com/rudironsoni/obsidian-git/commit/d11579c96932f0b2c16c7306c5a05cfbae2509b1))
* catch diff for deleted file ([710cd2c](https://github.com/rudironsoni/obsidian-git/commit/710cd2cc6e69c1561277c762518ba0ba903e91f3))
* catch error in diffView ([cbff377](https://github.com/rudironsoni/obsidian-git/commit/cbff37701fd8aa8b9e1257d09fb8ca9fb655b35b))
* catch git error on commit ([fe78ae3](https://github.com/rudironsoni/obsidian-git/commit/fe78ae364e5296a378a3d0844a3daa53b3d024c7))
* catch huge auto intervals ([b96efc5](https://github.com/rudironsoni/obsidian-git/commit/b96efc5e06654f144d5837e784da297d79496c51)), closes [#153](https://github.com/rudironsoni/obsidian-git/issues/153)
* catch huge auto intervals ([35bca00](https://github.com/rudironsoni/obsidian-git/commit/35bca003c98637f65295fe7d5a8bc4ae1fd68b07)), closes [#153](https://github.com/rudironsoni/obsidian-git/issues/153)
* catch more git errors ([153fd82](https://github.com/rudironsoni/obsidian-git/commit/153fd82d7467d6c58905fa77c4376b2e79594810))
* catch not existing tracking branch ([5833ed3](https://github.com/rudironsoni/obsidian-git/commit/5833ed39c4c14e6c88e58713368c6a558a71425a))
* catch sidebar leaf being null ([86065c9](https://github.com/rudironsoni/obsidian-git/commit/86065c987bb478cbf65b4baca1745d7162041b5d))
* catch ssh network failure ([62e4a6a](https://github.com/rudironsoni/obsidian-git/commit/62e4a6a255e2ceedd38e4a016fa92f407e052485)), closes [#211](https://github.com/rudironsoni/obsidian-git/issues/211)
* center buttons in discard modal ([79a1e86](https://github.com/rudironsoni/obsidian-git/commit/79a1e86ce5ba7e039393c49414b0e408e940aaa5))
* change "auto push" setting to "disable push" to resolve issues with obsidian settings not loading correctly ([e00014c](https://github.com/rudironsoni/obsidian-git/commit/e00014cb269efa6391ebeb1d1e0026d209635bfe))
* change conficted files type ([d1a557c](https://github.com/rudironsoni/obsidian-git/commit/d1a557cba52c907db3331f5c70763d6fb7bc103d))
* changed files path was wrong with whitespaces ([043f02f](https://github.com/rudironsoni/obsidian-git/commit/043f02f89daea8051612b5f7816564ba7f7657e8)), closes [#119](https://github.com/rudironsoni/obsidian-git/issues/119)
* Changed the branchLocal command to branch with no-color ([dbd93cf](https://github.com/rudironsoni/obsidian-git/commit/dbd93cfe5f127874a514837577b42b34a07bcf3e))
* check existing repo ([9ef8096](https://github.com/rudironsoni/obsidian-git/commit/9ef809660674de1ec97819a4eae399623a481351))
* check file size for non Obsidian files as well ([0754fd8](https://github.com/rudironsoni/obsidian-git/commit/0754fd87ba5e947096466c3a63890da12e0159ca)), closes [#859](https://github.com/rudironsoni/obsidian-git/issues/859)
* check for too big files in source control view ([2275d4f](https://github.com/rudironsoni/obsidian-git/commit/2275d4f716c00a305bf4371e9cb1b934669b2272))
* check remote branch ([cb11b45](https://github.com/rudironsoni/obsidian-git/commit/cb11b453672931950d333eab1b23ca3a486604b2))
* checkRequirements cant find user.name/email ([1994a44](https://github.com/rudironsoni/obsidian-git/commit/1994a44c5ecec121965505e2627d26460425e4dd))
* clarification about disabling notifications ([#249](https://github.com/rudironsoni/obsidian-git/issues/249)) ([f90b284](https://github.com/rudironsoni/obsidian-git/commit/f90b284f1f4140eab6aec1b77353cb52e661a8e3))
* Clarification which information was not set ([#802](https://github.com/rudironsoni/obsidian-git/issues/802)) ([45ba119](https://github.com/rudironsoni/obsidian-git/commit/45ba119fff28547772c59856f2abf8700e544149))
* clarify backup after file change setting ([30d12ca](https://github.com/rudironsoni/obsidian-git/commit/30d12ca872c523cc3d6ee2987c2299270f50a578)), closes [#575](https://github.com/rudironsoni/obsidian-git/issues/575)
* clear autobackup/pull correctly ([1c5eeab](https://github.com/rudironsoni/obsidian-git/commit/1c5eeab098609ab5925a2ddda3aeef76db2660b3))
* close empty leaf of deleted conflict file ([cd6027d](https://github.com/rudironsoni/obsidian-git/commit/cd6027dcb8f3f9c353c9e9f9592b057c06fceb70)), closes [#401](https://github.com/rudironsoni/obsidian-git/issues/401)
* commit in source control view ([90985b1](https://github.com/rudironsoni/obsidian-git/commit/90985b1b7733eb39247b3aaa71ddc2482012f272)), closes [#686](https://github.com/rudironsoni/obsidian-git/issues/686)
* commit only staged files ([f71fdf5](https://github.com/rudironsoni/obsidian-git/commit/f71fdf58271c1490887f057c6ecc5e6d3689dbd4)), closes [#253](https://github.com/rudironsoni/obsidian-git/issues/253)
* commit only staged files, again ([ba35555](https://github.com/rudironsoni/obsidian-git/commit/ba35555eebbac5f4a69aaa7da6847928e0ddd017)), closes [#253](https://github.com/rudironsoni/obsidian-git/issues/253)
* conflict files pane was opened on pull error ([8d43e7b](https://github.com/rudironsoni/obsidian-git/commit/8d43e7b32e7b5082c3518537ce32c0627b35dfb2))
* correct committed files count ([8a985d6](https://github.com/rudironsoni/obsidian-git/commit/8a985d68dd6c00650df0ddea36fb878f4473bf4b))
* correct git dir for clone on mobile ([0b06487](https://github.com/rudironsoni/obsidian-git/commit/0b0648716f790e2676509b77dee444a72ef06814))
* correct height for textarea ([b44c900](https://github.com/rudironsoni/obsidian-git/commit/b44c9008db9b12b1e4f23ef5fc87151618953231))
* correct on click handler ([9c84ea3](https://github.com/rudironsoni/obsidian-git/commit/9c84ea3b28440125fb3bee27eace03c330b3c26d))
* correct pull changes count ([6aead15](https://github.com/rudironsoni/obsidian-git/commit/6aead155571eda2499ef1ab6377236152124df96)), closes [#198](https://github.com/rudironsoni/obsidian-git/issues/198)
* correctly abort selection when no branch selected ([23c009a](https://github.com/rudironsoni/obsidian-git/commit/23c009a2e9d23f0be6c882b2b992248e24bcf2da))
* correctly debounce metadatacache ([0548666](https://github.com/rudironsoni/obsidian-git/commit/054866661dfbd5c2fd9cefff9a78e39549ef17bd))
* correctly set non-existing remote branch as upstream branch ([8283e10](https://github.com/rudironsoni/obsidian-git/commit/8283e10a26492c6359e68219750be5951e8c090d)), closes [#599](https://github.com/rudironsoni/obsidian-git/issues/599)
* correctly update `.lastUpdate` timestamp during push/pull ([4b61297](https://github.com/rudironsoni/obsidian-git/commit/4b61297be84fa7940e2909ddfdd2ef1d8608e20d))
* create .gitignore if not exists ([ac8e3ee](https://github.com/rudironsoni/obsidian-git/commit/ac8e3ee380340fbeedf0dac8e80a4c28aeadffa8))
* create div element different for sign markers ([3815bd2](https://github.com/rudironsoni/obsidian-git/commit/3815bd23b93905de27fe13cf5a59499d418ee3ed))
* create new remote ([1a4cca8](https://github.com/rudironsoni/obsidian-git/commit/1a4cca8baf20de91ce3ee825740a85f1d33c1744)), closes [#599](https://github.com/rudironsoni/obsidian-git/issues/599)
* create new upstream branch ([c5a95c1](https://github.com/rudironsoni/obsidian-git/commit/c5a95c1ac9d9a0788d3ae053e83a11dbc30e590d)), closes [#808](https://github.com/rudironsoni/obsidian-git/issues/808)
* declare ALLOWSIMPLEGIT as global ([6faf703](https://github.com/rudironsoni/obsidian-git/commit/6faf7030aa9dcbbfeae952eb8ca21f0cf9b17905))
* detect another error message for offline mode ([387d4bd](https://github.com/rudironsoni/obsidian-git/commit/387d4bd895a5fd04df80cd0705705d93e7fce4bd)), closes [#990](https://github.com/rudironsoni/obsidian-git/issues/990)
* detect missing .git/index file ([8521891](https://github.com/rudironsoni/obsidian-git/commit/85218917873e38bdc6e07635aa992be4a140addb))
* detect network unreachable ([76b894c](https://github.com/rudironsoni/obsidian-git/commit/76b894c21085ff99d2f0bbaf1c4f46351e3f19f1)), closes [#211](https://github.com/rudironsoni/obsidian-git/issues/211)
* detect utf8 encoding properly ([688d70e](https://github.com/rudironsoni/obsidian-git/commit/688d70e0066945a8be0716a9e035a6cc2dda2809))
* diff of new file ([92d24bf](https://github.com/rudironsoni/obsidian-git/commit/92d24bf8f25749f48ea8646088adec55a1ae2c25)), closes [#277](https://github.com/rudironsoni/obsidian-git/issues/277)
* different tree data structure ([0fd2f95](https://github.com/rudironsoni/obsidian-git/commit/0fd2f954b66f0336475f8babb1904130711cbc50))
* disable check for root git repository ([49a68e0](https://github.com/rudironsoni/obsidian-git/commit/49a68e0396b46c09a49f03898b804f97d1a709b3)), closes [#55](https://github.com/rudironsoni/obsidian-git/issues/55) [#11](https://github.com/rudironsoni/obsidian-git/issues/11)
* disable line authoring on mobile ([ac28656](https://github.com/rudironsoni/obsidian-git/commit/ac2865676135a22a81f8d1a440825e7583aa73ec))
* disable obscure for username question ([12c5313](https://github.com/rudironsoni/obsidian-git/commit/12c531364127ab33c08754ad1f58eda46f7f48c9)), closes [#1000](https://github.com/rudironsoni/obsidian-git/issues/1000)
* disable refresh source control by default on mobile ([ad9d0f8](https://github.com/rudironsoni/obsidian-git/commit/ad9d0f8a556f6e377bc5080c8584b28a51b702d0))
* disable staged hunks as their computation is not feasible ([5ff0fed](https://github.com/rudironsoni/obsidian-git/commit/5ff0fede7f15d4ae3e7e9e0b2c445ec1cced0d59))
* disallow clone in vault root on desktop ([c073d19](https://github.com/rudironsoni/obsidian-git/commit/c073d19283c01af4fdc79002d1913b1d5672a5fd)), closes [#540](https://github.com/rudironsoni/obsidian-git/issues/540)
* discard ([23e262d](https://github.com/rudironsoni/obsidian-git/commit/23e262de59e627f408037896f1ea167a5349a6f9))
* discard deleted files ([42bf536](https://github.com/rudironsoni/obsidian-git/commit/42bf536b7973ef35a251a88fa61127b9a3b9972d))
* discard files correctly ([1c4e0c3](https://github.com/rudironsoni/obsidian-git/commit/1c4e0c3e37fbc466d33a2f0e8089a65f4de8b103))
* discard not tracked directory ([183929b](https://github.com/rudironsoni/obsidian-git/commit/183929b0cf3da47670faf930d3b6700df65db5c4))
* dispose listeners on view close ([31c02b0](https://github.com/rudironsoni/obsidian-git/commit/31c02b0fac229224dbe0ba69eaea2134d1792d22))
* do not alter Obsidian's own process env vars ([b8bd1ec](https://github.com/rudironsoni/obsidian-git/commit/b8bd1ec521561f6888857852cb565f66cc6a2241)), closes [#1041](https://github.com/rudironsoni/obsidian-git/issues/1041)
* does not push when no changes detected (fix [#33](https://github.com/rudironsoni/obsidian-git/issues/33)) ([d016dee](https://github.com/rudironsoni/obsidian-git/commit/d016dee92db4af02446b112de580b5197a3303f3))
* don't checkout when nothing changed after merge ([f807d8a](https://github.com/rudironsoni/obsidian-git/commit/f807d8a19712bc8f697e37ba1a571b47be77c064))
* don't collapse changed files on stage and add bottom padding ([3832059](https://github.com/rudironsoni/obsidian-git/commit/38320597ec712804eecc04dfcd64ce774963c303))
* don't discard ignored files ([5483881](https://github.com/rudironsoni/obsidian-git/commit/54838815eae722a386de17fff71a1434bc6d9f84)), closes [#1006](https://github.com/rudironsoni/obsidian-git/issues/1006)
* don't include all files in status on mobile ([8410e32](https://github.com/rudironsoni/obsidian-git/commit/8410e3219ae68b7fd9bea39274e0d81155a560f3))
* don't open diff for binary files, just open them instead ([4c102fb](https://github.com/rudironsoni/obsidian-git/commit/4c102fb881764ba30a048b765926eda577c9f5f7)), closes [#801](https://github.com/rudironsoni/obsidian-git/issues/801)
* don't overwrite debug logging of other packages ([#905](https://github.com/rudironsoni/obsidian-git/issues/905)) ([c258fe2](https://github.com/rudironsoni/obsidian-git/commit/c258fe2bcb45be83833f07e5d8d2b788f5571992))
* don't refresh views if git client is not ready ([7887c7f](https://github.com/rudironsoni/obsidian-git/commit/7887c7f4518fd2f1f83810ad3fc13cb53af4fe19))
* don't remove dom elements in line authoring ([4b29d76](https://github.com/rudironsoni/obsidian-git/commit/4b29d76df035be329c55f5718a0542a85bf2f941))
* don't require .git suffix to open file on github ([9b264bf](https://github.com/rudironsoni/obsidian-git/commit/9b264bffb49a36d86f8af4c17435de2e6ca6c580)), closes [#753](https://github.com/rudironsoni/obsidian-git/issues/753)
* don't reschedule auto commit-and-sync too often ([7f506c7](https://github.com/rudironsoni/obsidian-git/commit/7f506c7d54cc83bebcf14e22207c53e57a55add0)), closes [#875](https://github.com/rudironsoni/obsidian-git/issues/875)
* don't reset auto commit-and-sync timer while still running ([bd5b942](https://github.com/rudironsoni/obsidian-git/commit/bd5b9423eb6f90dce2e078cffa7591a4634bfc87))
* don't show mobile notice on mobile ([c93ddfa](https://github.com/rudironsoni/obsidian-git/commit/c93ddfaee5d7621248f2ed1183b8819a7d216706))
* don't show mobile notice on new installation ([218f002](https://github.com/rudironsoni/obsidian-git/commit/218f002f433ec3a69f92ebfdf1876c50cd99e85c))
* don't show push notice on empty push ([9986667](https://github.com/rudironsoni/obsidian-git/commit/998666778ed07f380b6a4057afc33ca637c472c7))
* don't start autobackup with 0 interval time ([a36c741](https://github.com/rudironsoni/obsidian-git/commit/a36c741cb1a5e557615768af3656dc76d6391ed0))
* don't use new auto backup after change by default ([cc95a96](https://github.com/rudironsoni/obsidian-git/commit/cc95a96613386c30c379457d7d33198808403c63))
* don't use spawnSync, but a non-blocking alternative ([ad03171](https://github.com/rudironsoni/obsidian-git/commit/ad03171300604b968340ca9212790da01b6ba1fd))
* duplicated history view ([ec0668d](https://github.com/rudironsoni/obsidian-git/commit/ec0668d6a69e9907aa8174976e3030f8c289be90)), closes [#800](https://github.com/rudironsoni/obsidian-git/issues/800)
* duplicated status bar ([f653019](https://github.com/rudironsoni/obsidian-git/commit/f65301946ee7d3160f5b6b00ca2f0aec8e0ef6ed)), closes [#892](https://github.com/rudironsoni/obsidian-git/issues/892)
* easier fix for newer Obsidian versions ([75625a0](https://github.com/rudironsoni/obsidian-git/commit/75625a08b5e0307226dcfebb53a21d0ca9a93eb8))
* escape file path for css selector ([c6fcbdf](https://github.com/rudironsoni/obsidian-git/commit/c6fcbdf7fa813bfcf3047fd41174d60ea3ffdbf1)), closes [#986](https://github.com/rudironsoni/obsidian-git/issues/986)
* **events:** clean up EventsPerFilePath interval timer on plugin unload ([#1124](https://github.com/rudironsoni/obsidian-git/issues/1124)) ([93e2231](https://github.com/rudironsoni/obsidian-git/commit/93e2231c2a8875036b10b81510d3f9eaa58ac4f2))
* expand selection width on stagedFileComponent too ([daf8ac7](https://github.com/rudironsoni/obsidian-git/commit/daf8ac7e4279d6334fd36b4706c85c77d2e8dbbe))
* export mock IsomorphicGit.ts ([aa5fa37](https://github.com/rudironsoni/obsidian-git/commit/aa5fa37579903243f6623fa99592203c76cd5478)), closes [#281](https://github.com/rudironsoni/obsidian-git/issues/281)
* fallback to debounced diff for slow diffs ([cfac162](https://github.com/rudironsoni/obsidian-git/commit/cfac162d52cddc5b3435ae95277ea1a7cce8ba9c))
* file status on mobile ([d207a01](https://github.com/rudironsoni/obsidian-git/commit/d207a011407a5d81e9a28ca8e78489f959b18941))
* fix `undefined` backup settings and rearrange settings a bit ([68f8b84](https://github.com/rudironsoni/obsidian-git/commit/68f8b8438c9aba3c314ee2baa857bfd1efd587d2))
* fix plugin getting stuck at "checking repo status.." message ([4875519](https://github.com/rudironsoni/obsidian-git/commit/4875519f9986946f0628a343c8ffd94686b86fa4))
* fix status bar messages race conditions ([f3f0a63](https://github.com/rudironsoni/obsidian-git/commit/f3f0a63132e0cd38c27d0e14c08a8b7c59134a83))
* focus diff view via command ([e56641c](https://github.com/rudironsoni/obsidian-git/commit/e56641c25f9672fcffeb0801f09ca7eadf99ede0)), closes [#377](https://github.com/rudironsoni/obsidian-git/issues/377)
* fold only one item ([cd1d932](https://github.com/rudironsoni/obsidian-git/commit/cd1d93226a4e2f5ebfaa89ada97851c60f35a4fd)), closes [#680](https://github.com/rudironsoni/obsidian-git/issues/680)
* format commit message ([0078573](https://github.com/rudironsoni/obsidian-git/commit/007857358b43639422c856bcaa907609008820ff))
* full directory path on hover ([0f2c9d5](https://github.com/rudironsoni/obsidian-git/commit/0f2c9d56b1733450283af487c740d01908201284))
* get last commit time on branch without commits ([73300a1](https://github.com/rudironsoni/obsidian-git/commit/73300a1bf7c6333ea389a6792f73ea412b7f751d))
* get old path of renamed file ([b31a855](https://github.com/rudironsoni/obsidian-git/commit/b31a855102cd8f81a5a36cae160bac77b96ddfd6)), closes [#944](https://github.com/rudironsoni/obsidian-git/issues/944)
* get unset config values ([e229c22](https://github.com/rudironsoni/obsidian-git/commit/e229c227acd21d0a1674218b2a778726c3849908))
* git repository check ([98fa9f7](https://github.com/rudironsoni/obsidian-git/commit/98fa9f758f9b08546c0c9319a14fd25b85af4503))
* **gitManager:** prevent naive path slicing and trailing slashes ([#1126](https://github.com/rudironsoni/obsidian-git/issues/1126)) ([8abc25d](https://github.com/rudironsoni/obsidian-git/commit/8abc25d05e5f4d24cdbe0ce0c0e416a9669e4d5f))
* **git:** support recursive flag directly in rmdir for isomorphic-git ([#1116](https://github.com/rudironsoni/obsidian-git/issues/1116)) ([6f3bbb3](https://github.com/rudironsoni/obsidian-git/commit/6f3bbb3fae3ce8c84356b3f267ed0807f2ff24d5))
* grammar improvement in settings ([#635](https://github.com/rudironsoni/obsidian-git/issues/635)) ([1d81577](https://github.com/rudironsoni/obsidian-git/commit/1d81577877ccb548b06fb91036a246aa442a41ae))
* handle "Add to .gitignore" edgecases and make the added path absolute ([#890](https://github.com/rudironsoni/obsidian-git/issues/890)) ([485e4cd](https://github.com/rudironsoni/obsidian-git/commit/485e4cda3d374cc5e0d5ea93b0496f6ef24d1aa3))
* handle conflict when using simplegit ([6195ce3](https://github.com/rudironsoni/obsidian-git/commit/6195ce3b1b604f26768244f7633a1bac19888633))
* handle github link errors ([#445](https://github.com/rudironsoni/obsidian-git/issues/445)) ([fd294cc](https://github.com/rudironsoni/obsidian-git/commit/fd294ccf50237c24000559d0d99cff4758e43b1a))
* handle having a config value defined multiple times ([8e15ddc](https://github.com/rudironsoni/obsidian-git/commit/8e15ddc3bc2ce27b8c0afbc736ccc0258daffe3b)), closes [#1038](https://github.com/rudironsoni/obsidian-git/issues/1038)
* handle merge conflict better ([101aff9](https://github.com/rudironsoni/obsidian-git/commit/101aff991ecaecd57f004dd7bfd1811866b755e5))
* handle missing tracking branch ([#483](https://github.com/rudironsoni/obsidian-git/issues/483)) ([703fc18](https://github.com/rudironsoni/obsidian-git/commit/703fc18e7dccec89c810e6529a869ec5c271c21e))
* hide 'finished pull'  notice when hiding notifications ([8ba0e75](https://github.com/rudironsoni/obsidian-git/commit/8ba0e7526001eaefed71b2978e9f1ab76ab18136)), closes [#292](https://github.com/rudironsoni/obsidian-git/issues/292)
* hide line authoring on small width window([#684](https://github.com/rudironsoni/obsidian-git/issues/684)) ([6a89424](https://github.com/rudironsoni/obsidian-git/commit/6a89424231ab45ca7741a6d9b96693f63ca40e6e))
* hide line authoring settings on mobile ([c135c0b](https://github.com/rudironsoni/obsidian-git/commit/c135c0b49cd0cc8033ea40f64e6f922702375aa0))
* hide notification on mobile ([7d62527](https://github.com/rudironsoni/obsidian-git/commit/7d6252795ca62f4176fee90d674041659a0a1d9f)), closes [#292](https://github.com/rudironsoni/obsidian-git/issues/292)
* hide pulled files when empty ([8267e1b](https://github.com/rudironsoni/obsidian-git/commit/8267e1b21910ccadc14f25caa976e05947a1cf91))
* highlight staged file on hover ([ef0d3e6](https://github.com/rudironsoni/obsidian-git/commit/ef0d3e6640712669e8d303d7cf1bff7dbdedbc7d))
* http calls on newer Obsidian versions ([a4cd006](https://github.com/rudironsoni/obsidian-git/commit/a4cd006949102bf1f790b844ff1783b8d9618edc))
* important fixes for diff view ([e5509f9](https://github.com/rudironsoni/obsidian-git/commit/e5509f981a51638c910f5cc960737b25d77a36ab))
* improve adapter performance ([4f6f778](https://github.com/rudironsoni/obsidian-git/commit/4f6f778cd43a2d1d42a437c170a85b0495a02ba4))
* improve base path description ([8ee3a63](https://github.com/rudironsoni/obsidian-git/commit/8ee3a63fff91d4c9fd61cb9da73cc738026b8af1))
* improve conflict support ([c71d1b0](https://github.com/rudironsoni/obsidian-git/commit/c71d1b0932b5738850bef7311db22ccb8e874dea))
* improve division of staged and not staged ([7cb8e6a](https://github.com/rudironsoni/obsidian-git/commit/7cb8e6a593dcbaf93e49bde870ab4dd30cd16cec))
* improve settings ui ([#886](https://github.com/rudironsoni/obsidian-git/issues/886)) ([edbbfb6](https://github.com/rudironsoni/obsidian-git/commit/edbbfb610462a3dd85436b4d97e74adfc4bcee7d))
* improve the "is file openable in obsidian" check ([#884](https://github.com/rudironsoni/obsidian-git/issues/884)) ([f7b286c](https://github.com/rudironsoni/obsidian-git/commit/f7b286cf0fb146cdd59a39302796e13a744e9c77))
* init slowed Obsidian startup time down ([e3f559c](https://github.com/rudironsoni/obsidian-git/commit/e3f559c14b54ef97eb8d07397d8b92250eeb3d62)), closes [#72](https://github.com/rudironsoni/obsidian-git/issues/72)
* initialization procedure (fix [#27](https://github.com/rudironsoni/obsidian-git/issues/27)) ([1d71418](https://github.com/rudironsoni/obsidian-git/commit/1d714181d8967fa6089cd380b879ce652332a3fa))
* **isomorphicGit:** support root commits in diff generation ([#1127](https://github.com/rudironsoni/obsidian-git/issues/1127)) ([616fe86](https://github.com/rudironsoni/obsidian-git/commit/616fe86ffa52054529617d930b0f58478f73cc31))
* **isomorphic:** pull ([84d34fc](https://github.com/rudironsoni/obsidian-git/commit/84d34fcd656c765f0a3dc273382ec1496ccc4cc4))
* jittering of refresh button ([dbf36b2](https://github.com/rudironsoni/obsidian-git/commit/dbf36b2a63617b4d937f75326cd007ea08cfb622))
* keep git view on unload ([8b846da](https://github.com/rudironsoni/obsidian-git/commit/8b846da0010a852b5422d64034c1e4b309fa7f35)), closes [#321](https://github.com/rudironsoni/obsidian-git/issues/321)
* lastUpate gets changed when no changes are detected ([71d2a59](https://github.com/rudironsoni/obsidian-git/commit/71d2a59f1d5ea7f7fd08e77b1802a47d0aae3f46))
* less gutter updates for same git result ([4da4c64](https://github.com/rudironsoni/obsidian-git/commit/4da4c647feded146f2e5896e20b50b2319415d0d))
* limit amount of files to list in commit msg ([a0416ed](https://github.com/rudironsoni/obsidian-git/commit/a0416edf5f3ac5d9adc9fc37cf9a9c932583ced4))
* line authoring crashes when dom Element cannot be removed. ([#891](https://github.com/rudironsoni/obsidian-git/issues/891)) ([2d2ebfd](https://github.com/rudironsoni/obsidian-git/commit/2d2ebfd9a91aae636215f03e0620bc14c357e333))
* list files in commit body ([f52a18b](https://github.com/rudironsoni/obsidian-git/commit/f52a18b3a3b6b05d643541baf2f74c32bb3e88d4)), closes [#131](https://github.com/rudironsoni/obsidian-git/issues/131)
* load more logs in history view on scroll ([a17cb55](https://github.com/rudironsoni/obsidian-git/commit/a17cb55bcffd7e0e6028c72b5b0704fb6fb3fe00)), closes [#807](https://github.com/rudironsoni/obsidian-git/issues/807)
* localstorage migration ([1d9391a](https://github.com/rudironsoni/obsidian-git/commit/1d9391a970624f03fcc60fb68f3bd8ee450af24b))
* make  `{{files}}` variable visible in settings ([#536](https://github.com/rudironsoni/obsidian-git/issues/536)) ([07abcce](https://github.com/rudironsoni/obsidian-git/commit/07abcce878a66e686e7f0221c68df746f69b590b))
* make diff buttons horizontal ([5d2627c](https://github.com/rudironsoni/obsidian-git/commit/5d2627c3b31ec233402c5cf58f3e86a292ee19a1))
* Make the spelling of .gitignore consistent ([#805](https://github.com/rudironsoni/obsidian-git/issues/805)) ([8366927](https://github.com/rudironsoni/obsidian-git/commit/836692735d1cadb0023cd503573a58a14c76299e))
* make view header buttons sticky and contain scrollbar to body ([#864](https://github.com/rudironsoni/obsidian-git/issues/864)) ([953dbd4](https://github.com/rudironsoni/obsidian-git/commit/953dbd4ac350e7c119439b3ddbf8951377464369))
* many issues with list changed files ([8b3fc8b](https://github.com/rudironsoni/obsidian-git/commit/8b3fc8bd69b76193086d5b3a814546a9e3cf51ea)), closes [#655](https://github.com/rudironsoni/obsidian-git/issues/655)
* many minor fixes ([7d29bef](https://github.com/rudironsoni/obsidian-git/commit/7d29bef4ed7793b399a704f73a3ab458e043e595))
* middle click to open file/diff in new tab ([ddb1164](https://github.com/rudironsoni/obsidian-git/commit/ddb1164b10f5e0d373daaa4cd8ec4d60119cc544))
* minor new sync method fixes ([f1d6b33](https://github.com/rudironsoni/obsidian-git/commit/f1d6b334972b76271a15883c31784812f24d6878))
* minor source control view improvements ([fd7792c](https://github.com/rudironsoni/obsidian-git/commit/fd7792c80403d884d09c31bb09a76799bbd0dff0))
* missing git file status 113 ([#537](https://github.com/rudironsoni/obsidian-git/issues/537)) ([ba2b40c](https://github.com/rudironsoni/obsidian-git/commit/ba2b40cbc5687f92ab9ca6a65110d5d6ec39c2ca))
* **mobile:** apply git dir relative to base path instead of vault ([8123201](https://github.com/rudironsoni/obsidian-git/commit/8123201f3f6c9c129c2879f0a05c0ef6929f55ac))
* **mobile:** clone and delete local config dir ([9b0bc8a](https://github.com/rudironsoni/obsidian-git/commit/9b0bc8afb2f21440382f40a442dfc7b1bd369cca))
* **mobile:** flush index after concurrent staging ([691a872](https://github.com/rudironsoni/obsidian-git/commit/691a872bbb0c2dead1a5f727943d78565525f8f6))
* **mobile:** readdir with empty base path ([1c38b91](https://github.com/rudironsoni/obsidian-git/commit/1c38b913d15ed6a2410eeb9b0da7ae9675ef3ab3))
* **mobile:** set correct base path after clone ([3a69b79](https://github.com/rudironsoni/obsidian-git/commit/3a69b79583d3e76b22b36ef5c414fc4b98d1fdb7)), closes [#282](https://github.com/rudironsoni/obsidian-git/issues/282)
* **mobile:** stricter check for index file ([54174af](https://github.com/rudironsoni/obsidian-git/commit/54174aff35d9c540441c6e720a537363c9b625de))
* **mobile:** use more vault fs apis and set ctime of cached index properly ([1d1a338](https://github.com/rudironsoni/obsidian-git/commit/1d1a338824e4f7d6e89742665ace5657456ed96f))
* more efficient too big file check ([43c70d8](https://github.com/rudironsoni/obsidian-git/commit/43c70d8c85e9471b5d859ad7026ef6e44161118c)), closes [#822](https://github.com/rudironsoni/obsidian-git/issues/822)
* move commit msg setting to correct heading ([88eabc9](https://github.com/rudironsoni/obsidian-git/commit/88eabc930ca98ea205d366e874a245af964efabd))
* move repo to method ([633234d](https://github.com/rudironsoni/obsidian-git/commit/633234d42603bf8aaa71330c0c189b335de92be8))
* needed tracking branch to commit ([619c5d1](https://github.com/rudironsoni/obsidian-git/commit/619c5d182e95c5f1ca946c56d8c002e6b3f09daf))
* obscure password for ssh passphrase prompt ([5dbd3cd](https://github.com/rudironsoni/obsidian-git/commit/5dbd3cd8dedb4ccd97326205392cbd63702152d5)), closes [#845](https://github.com/rudironsoni/obsidian-git/issues/845)
* obscure password prompt in isomorphic-git auth ([#1007](https://github.com/rudironsoni/obsidian-git/issues/1007)) ([174cad8](https://github.com/rudironsoni/obsidian-git/commit/174cad88ab81e232e6b14abaebe4482afefa3846))
* only check files to be committed for big files ([91654ef](https://github.com/rudironsoni/obsidian-git/commit/91654ef1e0a29fe4b8e67612b25c314a2cb95eb9)), closes [#966](https://github.com/rudironsoni/obsidian-git/issues/966)
* only show non 0 numbers in change status bar ([9ee0c06](https://github.com/rudironsoni/obsidian-git/commit/9ee0c06c0d5595f89fdc371942a1f60692d87403))
* open diff in new leaf ([6914830](https://github.com/rudironsoni/obsidian-git/commit/6914830ce03651b7f9604ba7be81581636a34f5b)), closes [#306](https://github.com/rudironsoni/obsidian-git/issues/306)
* open diff view in correct pane ([96d2913](https://github.com/rudironsoni/obsidian-git/commit/96d2913c67bf8348953440954d5e41986c6b121b)), closes [#252](https://github.com/rudironsoni/obsidian-git/issues/252)
* open diffs in new split with middle click ([65ef5ba](https://github.com/rudironsoni/obsidian-git/commit/65ef5ba2fa783717baaea24d05c6dcc8e760596d))
* open file on github from submodule ([4981f8b](https://github.com/rudironsoni/obsidian-git/commit/4981f8bcc2eacda44fcebf8a95f458acd514febc)), closes [#592](https://github.com/rudironsoni/obsidian-git/issues/592)
* open file with custom base path ([8a11666](https://github.com/rudironsoni/obsidian-git/commit/8a11666e6d430ed3fba952a584b9f8af6cc462fe))
* open files from source control view ([0d5ec26](https://github.com/rudironsoni/obsidian-git/commit/0d5ec262187281517c4a63a78c417c8d9940750f)), closes [#258](https://github.com/rudironsoni/obsidian-git/issues/258)
* open general modal ([2a0bbd1](https://github.com/rudironsoni/obsidian-git/commit/2a0bbd13aaff41bf08386133441b4681983538a2)), closes [#798](https://github.com/rudironsoni/obsidian-git/issues/798)
* open renamed files and update UI correctly ([c1b052b](https://github.com/rudironsoni/obsidian-git/commit/c1b052bdcf43ed1a6dc109ce25160024eaf56731))
* password field description ([9dc5f7c](https://github.com/rudironsoni/obsidian-git/commit/9dc5f7c7bab3a3b1b24d42ae2fadb10e48cbc292)), closes [#293](https://github.com/rudironsoni/obsidian-git/issues/293)
* plugin started wrong when normally enabled ([dc9c4b1](https://github.com/rudironsoni/obsidian-git/commit/dc9c4b13387067793e315a9aca24c05c75fb6d38))
* plugin status bar now displays time from last update (push or pull) ([b835fc3](https://github.com/rudironsoni/obsidian-git/commit/b835fc3548884dca4084ec37a296ebebf9c9dab7))
* prepend custom PATH instead of append ([b8da471](https://github.com/rudironsoni/obsidian-git/commit/b8da471eaf342eb3450cc13cc7a3c57887c7e7d3)), closes [#981](https://github.com/rudironsoni/obsidian-git/issues/981)
* prevent  "detached HEAD" state after using "Switch to remote branch" command ([#1052](https://github.com/rudironsoni/obsidian-git/issues/1052)) ([b0dea07](https://github.com/rudironsoni/obsidian-git/commit/b0dea07db29cb569c0e40e6c300d3f7eddcdd95a))
* prevent corrupted packfiles from compressed fetch responses on mobile ([#1098](https://github.com/rudironsoni/obsidian-git/issues/1098)) ([0543b01](https://github.com/rudironsoni/obsidian-git/commit/0543b010e485632f9b8643aea39f0bb5046c7f18))
* prevent initializing plugin on disabled device ([750e11c](https://github.com/rudironsoni/obsidian-git/commit/750e11c83d429c8e4dea22e2908ce208b421c301)), closes [#1111](https://github.com/rudironsoni/obsidian-git/issues/1111)
* Prevent jitter of refresh icon in mobile ([#941](https://github.com/rudironsoni/obsidian-git/issues/941)) ([180a314](https://github.com/rudironsoni/obsidian-git/commit/180a314ca65bf666a8e15aaa07dc0d6b1e1ec838))
* **promiseQueue:** prevent race conditions on clear and handle sync errors ([#1123](https://github.com/rudironsoni/obsidian-git/issues/1123)) ([4bf5589](https://github.com/rudironsoni/obsidian-git/commit/4bf55899239a12d3cf97c9b1b485f5557662f1f3))
* proper types ([07084e9](https://github.com/rudironsoni/obsidian-git/commit/07084e91bee778ec561df942d31bfc15854d2a8b))
* proper utf-8 encoding ([1bc7d28](https://github.com/rudironsoni/obsidian-git/commit/1bc7d2844ec3b3a954abe3c11766fd1e2d1c1b2a)), closes [#121](https://github.com/rudironsoni/obsidian-git/issues/121)
* properly close toggle tree items ([69fdf79](https://github.com/rudironsoni/obsidian-git/commit/69fdf79c5b45a114043996b5fafd4839728f32e6)), closes [#950](https://github.com/rudironsoni/obsidian-git/issues/950)
* properly collapse icon in tree views ([919d7f8](https://github.com/rudironsoni/obsidian-git/commit/919d7f8f65174e76a4f13a992b3f37931eaf7262))
* properly color hovered icon buttons ([197a4c7](https://github.com/rudironsoni/obsidian-git/commit/197a4c7f82121b75e47ab61cae10ca0fb59e1587))
* properly compose debounced changes ([42cea82](https://github.com/rudironsoni/obsidian-git/commit/42cea821083fc4eca0bf291ec641623436f700f5)), closes [#1076](https://github.com/rudironsoni/obsidian-git/issues/1076)
* properly create div ([6b6f29f](https://github.com/rudironsoni/obsidian-git/commit/6b6f29fb7136f1b68582fe8f7d71f85c90606e10))
* properly disable auto pull ([f8464e6](https://github.com/rudironsoni/obsidian-git/commit/f8464e665850c0eac301a881b40b0c74809d4478)), closes [#816](https://github.com/rudironsoni/obsidian-git/issues/816)
* properly disable signs via settings ([bda731b](https://github.com/rudironsoni/obsidian-git/commit/bda731b15f36f69219e54943be1caace6b5de47a))
* properly hide md extension ([6494ccf](https://github.com/rudironsoni/obsidian-git/commit/6494ccf0375d3790202e803864d2f6cbd46d1269)), closes [#873](https://github.com/rudironsoni/obsidian-git/issues/873)
* properly manage extensions ([067144c](https://github.com/rudironsoni/obsidian-git/commit/067144cd3c6fddd88eb3c478de7baf6a46efb459))
* properly resolve merge conflict ([80c0b65](https://github.com/rudironsoni/obsidian-git/commit/80c0b65f8d0d8dc8dbddff61118bd79733ffce94)), closes [#502](https://github.com/rudironsoni/obsidian-git/issues/502)
* properly set absolute repo path for custom GIT_DIR ([0651d0b](https://github.com/rudironsoni/obsidian-git/commit/0651d0b82f3c8e636c60bd22b1c850e8facc7512))
* properly show tooltip ([f5a48af](https://github.com/rudironsoni/obsidian-git/commit/f5a48afde5e6ce3a971f70a2b3866313045b3bd8))
* pull progress and author ([3d8602b](https://github.com/rudironsoni/obsidian-git/commit/3d8602b58f6183cb5532915b486062b2284ba6dd))
* pulled files count ([9d61906](https://github.com/rudironsoni/obsidian-git/commit/9d619064e3c8ebf1500cec1cbbe7bfd1e75d6b59))
* push thought current conflict ([ffc76c2](https://github.com/rudironsoni/obsidian-git/commit/ffc76c281cf67b4a85bc21d377d79677004025b4))
* push with file named like branch ([2664bfe](https://github.com/rudironsoni/obsidian-git/commit/2664bfe633e9ea0c76123ed7b0d4ac56aaf05b10)), closes [#171](https://github.com/rudironsoni/obsidian-git/issues/171)
* pushed files count ([e50a185](https://github.com/rudironsoni/obsidian-git/commit/e50a185662abc14daa91e5da88c0557eabc9216e))
* **queue:** wrap onFinished in try-catch to prevent deadlock on callback error ([#1115](https://github.com/rudironsoni/obsidian-git/issues/1115)) ([2b5b1b7](https://github.com/rudironsoni/obsidian-git/commit/2b5b1b747a1f807e23a2daa3b8f498e5a6b6f7df))
* recognize click on correct tree component in source control view ([27d0e54](https://github.com/rudironsoni/obsidian-git/commit/27d0e54c92b2c2bbf8784ba3aea8b84363d2bc8a)), closes [#1066](https://github.com/rudironsoni/obsidian-git/issues/1066)
* recognize more errors as network issues ([4aceed3](https://github.com/rudironsoni/obsidian-git/commit/4aceed30c5b349431f7a5ed21c4d3b4bdabb88e7)), closes [#735](https://github.com/rudironsoni/obsidian-git/issues/735)
* recusrive submods ([#217](https://github.com/rudironsoni/obsidian-git/issues/217)) ([98f566f](https://github.com/rudironsoni/obsidian-git/commit/98f566ffa29bb99dde44615f52fd352c099bd7f4))
* refresh already opened views on open command ([fbb62ad](https://github.com/rudironsoni/obsidian-git/commit/fbb62ad0cece4dbf36518616312a29463c39227c)), closes [#838](https://github.com/rudironsoni/obsidian-git/issues/838)
* refresh cached file index version every 10 seconds ([4ba53a4](https://github.com/rudironsoni/obsidian-git/commit/4ba53a428bc61285f1bec37112f2996f234dcc12))
* refresh data on view loading ([73d2c29](https://github.com/rudironsoni/obsidian-git/commit/73d2c299298d3b11dd5a0e976b1187d46d17041e))
* refresh source control view less frequently ([b90b1a5](https://github.com/rudironsoni/obsidian-git/commit/b90b1a5fa596142f42698727dd76cadd97e9bdc6))
* refresh source control view on change ([45e54e2](https://github.com/rudironsoni/obsidian-git/commit/45e54e21d097492d35084e4b7c52e1f7df5c59b1))
* refresh source control view on exception ([c1eee7b](https://github.com/rudironsoni/obsidian-git/commit/c1eee7b0d378677dff4da75fc3945b88c3ede7d3)), closes [#183](https://github.com/rudironsoni/obsidian-git/issues/183)
* refresh source control view on first open ([6e75300](https://github.com/rudironsoni/obsidian-git/commit/6e75300424eb8d78f1a4c79caf830ce5d5fd1727))
* refresh status after opening source control view ([666b8a8](https://github.com/rudironsoni/obsidian-git/commit/666b8a8f263ce49a3d02dbfb040aa774cce95db2))
* refresh status bar after push ([ed31df8](https://github.com/rudironsoni/obsidian-git/commit/ed31df88effc5e686cb2e81e0379df93627bdd9b)), closes [#566](https://github.com/rudironsoni/obsidian-git/issues/566)
* refresh view when staging files from menu ([1bd92c3](https://github.com/rudironsoni/obsidian-git/commit/1bd92c3961ac311312ff20e9fa2e3067a95c0434))
* register event listener after initial load ([d32d0f4](https://github.com/rudironsoni/obsidian-git/commit/d32d0f4bc26db390da8008e8af878eef97ba98f4))
* register interval functions so Obsidian properly unloads them ([717a538](https://github.com/rudironsoni/obsidian-git/commit/717a53811ef55907ca804ead83d7db6a4747199f))
* relative to vault path ([a70c10a](https://github.com/rudironsoni/obsidian-git/commit/a70c10a4ef67264975a1abbfab745e8eb0633394))
* reload plugin after clone ([ce4f9bb](https://github.com/rudironsoni/obsidian-git/commit/ce4f9bb13c5cd44c1db459ae6e0a7a9a2057d0d3))
* reload plugin after clone ([87c66ce](https://github.com/rudironsoni/obsidian-git/commit/87c66ce1efc50b61ae6230fa88a45b0cb92bd623))
* reload plugin on clone ([82dc9c0](https://github.com/rudironsoni/obsidian-git/commit/82dc9c035a85b813a49e5c2ff3d5a5c604ae0323))
* remove root folding line in git views ([b2df0ed](https://github.com/rudironsoni/obsidian-git/commit/b2df0ed27b2af948df06dcc45021005b8c54e363))
* remove search symbol from commit message area ([8c58662](https://github.com/rudironsoni/obsidian-git/commit/8c58662071d10431d77ebbd8ee20b09df9ee913c))
* remove tree structure from settings ([5af00ae](https://github.com/rudironsoni/obsidian-git/commit/5af00ae593d573016694da3bc9bbb218c8baa978))
* remove unnecessary try catch ([a6618e3](https://github.com/rudironsoni/obsidian-git/commit/a6618e3bf67d7658c8298a0f0849138a758b140a))
* rename commands to be more consistend ([5e07e80](https://github.com/rudironsoni/obsidian-git/commit/5e07e80a13640b6ba587185880ba01befbd563ac))
* reorder settings item ([8d5b596](https://github.com/rudironsoni/obsidian-git/commit/8d5b59658500329b9f52a68127d619c3f5016906))
* replace '?' by 'U' for untracked files ([64cf162](https://github.com/rudironsoni/obsidian-git/commit/64cf1623e50513f0f46141f6860650d0a865238c))
* require upstream branch for pull ([3fac8ad](https://github.com/rudironsoni/obsidian-git/commit/3fac8ad86f8885ca322865b6e27f4a43b804a6ce)), closes [#261](https://github.com/rudironsoni/obsidian-git/issues/261)
* require valid repo for list changed files ([fe300c7](https://github.com/rudironsoni/obsidian-git/commit/fe300c767d4dac81ce9968e29106eaaf6aeb3ea2))
* reset changing an empty line ([9549bde](https://github.com/rudironsoni/obsidian-git/commit/9549bde6bd58f8186a558c5157a8f5ad3a9e4737))
* reset commit message to template ([16f0bd9](https://github.com/rudironsoni/obsidian-git/commit/16f0bd9fcf7a70687b529476bb4d9d5929375dbf)), closes [#828](https://github.com/rudironsoni/obsidian-git/issues/828)
* reset new empty line ([8cf494e](https://github.com/rudironsoni/obsidian-git/commit/8cf494e7375b62c4ec3e4cdefc8310c53dca0e19))
* respect custom base path in open in github ([c4e8acf](https://github.com/rudironsoni/obsidian-git/commit/c4e8acf62586b477434bd0c7e55c3ea0c0c99e8e)), closes [#284](https://github.com/rudironsoni/obsidian-git/issues/284)
* respect obsidian default hotkey for open diff ([271ec02](https://github.com/rudironsoni/obsidian-git/commit/271ec022d4caa91ebf0f4c1d82755bb879525ef6)), closes [#306](https://github.com/rudironsoni/obsidian-git/issues/306)
* respect obsidian default hotkey for open file ([b8631f4](https://github.com/rudironsoni/obsidian-git/commit/b8631f4ff0b9a0bdeacc829248195085f4512f1d)), closes [#306](https://github.com/rudironsoni/obsidian-git/issues/306)
* restart notice after clone ([140bed5](https://github.com/rudironsoni/obsidian-git/commit/140bed5cde1772b8c59a72db9ffa89a6eac9151e))
* retry auth with different credentials ([f8da5f4](https://github.com/rudironsoni/obsidian-git/commit/f8da5f455a15f27e93e8b317af3bf9dba7dc3d57)), closes [#296](https://github.com/rudironsoni/obsidian-git/issues/296)
* reveal source control view ([c88a1b4](https://github.com/rudironsoni/obsidian-git/commit/c88a1b43633e9964e3a9f60e94c0dc7f8307edc1))
* rework errors ([ee3eff4](https://github.com/rudironsoni/obsidian-git/commit/ee3eff46e0d98999e6ab312971392adc008d4f6e))
* run sh scripts on Windows using Git sh ([78bf00e](https://github.com/rudironsoni/obsidian-git/commit/78bf00e80197c74ac73425a2da0094e5f958d76b)), closes [#1045](https://github.com/rudironsoni/obsidian-git/issues/1045)
* save edits from split diff view for repo not in vault root ([71fe8dc](https://github.com/rudironsoni/obsidian-git/commit/71fe8dc1be54bfb2aa9dd3d1861b778c212a3a35)), closes [#985](https://github.com/rudironsoni/obsidian-git/issues/985)
* save localstorage per vault ([a3c4e4f](https://github.com/rudironsoni/obsidian-git/commit/a3c4e4f8916b78160de074e72444c5ccd91c32b2))
* save settings on plugin unload ([67cd7a3](https://github.com/rudironsoni/obsidian-git/commit/67cd7a3f9303505b86b6399694bf1d8e4c8bff4e))
* schedule new automatic after it finishes ([15416cb](https://github.com/rudironsoni/obsidian-git/commit/15416cb57ce126f8cd47cc8446bab77dd751815a)), closes [#851](https://github.com/rudironsoni/obsidian-git/issues/851)
* scroll line number in diff view ([1a01e30](https://github.com/rudironsoni/obsidian-git/commit/1a01e30357894980d8c5ffc77d2828af57174af7)), closes [#318](https://github.com/rudironsoni/obsidian-git/issues/318)
* select hunks and unstage no_nl_at_eof ([67ea27e](https://github.com/rudironsoni/obsidian-git/commit/67ea27e6925c901d6963ca27e7bf7a98a8bd29ed))
* set base path after clone ([0327090](https://github.com/rudironsoni/obsidian-git/commit/032709096b6afd8411868135596d5b9ef6c19fbd))
* set desktop only in manifest ([3cee0b0](https://github.com/rudironsoni/obsidian-git/commit/3cee0b07654933ec4fbc565b6a26233f94beb0d8))
* set GIT_WORK_TREE when using custom git directory ([#1064](https://github.com/rudironsoni/obsidian-git/issues/1064)) ([aee3e4f](https://github.com/rudironsoni/obsidian-git/commit/aee3e4f2e5030ddce5f9d4a8d4c17c41d518bc40))
* set path env var ([8a2ae4d](https://github.com/rudironsoni/obsidian-git/commit/8a2ae4dfe2ebb0023a351c251845d29a311a9560))
* set SSH_AKSPASS instead of GIT_ASKPASS and better error handling ([044cd6a](https://github.com/rudironsoni/obsidian-git/commit/044cd6a7ace2e2f18f146b4439344190943342ae))
* set upstream branch ([7aa5523](https://github.com/rudironsoni/obsidian-git/commit/7aa552378504322963a9dee33d7591d0eedbb00b))
* set upstream branch for existing remote branch ([c454b9d](https://github.com/rudironsoni/obsidian-git/commit/c454b9d7ae3323e5c9f4e758e139e97eb85ec40e)), closes [/github.com/denolehov/obsidian-git/issues/224#issuecomment-1229136511](https://github.com/rudironsoni//github.com/denolehov/obsidian-git/issues/224/issues/issuecomment-1229136511)
* **settings:** remove ability to enter non-number in number input boxes ([#880](https://github.com/rudironsoni/obsidian-git/issues/880)) ([18e966e](https://github.com/rudironsoni/obsidian-git/commit/18e966e3905814b4c7ba9918466529998a45e26e)), closes [#878](https://github.com/rudironsoni/obsidian-git/issues/878)
* show better diff view for non existing file ([07d9fce](https://github.com/rudironsoni/obsidian-git/commit/07d9fce47306a3315128327bec6e50ac351d9bff))
* show correct debug console hotkey ([087582e](https://github.com/rudironsoni/obsidian-git/commit/087582e429d96345c1f1ee17e0d6a1eeb71d9489)), closes [#175](https://github.com/rudironsoni/obsidian-git/issues/175)
* show correct empty diff ([c8bbe7c](https://github.com/rudironsoni/obsidian-git/commit/c8bbe7c5d2b7beb49ab5fa55922f289c2bcdbed1)), closes [#327](https://github.com/rudironsoni/obsidian-git/issues/327)
* show diff with custom base path ([fdde0bf](https://github.com/rudironsoni/obsidian-git/commit/fdde0bf83b4fedf430fe829724992207f1393d48))
* show error notices for a longer time ([d455489](https://github.com/rudironsoni/obsidian-git/commit/d45548993bcb95924a28f723d616e6c2f8c7c293)), closes [#148](https://github.com/rudironsoni/obsidian-git/issues/148)
* show file name in diff view on mobile ([20e0aba](https://github.com/rudironsoni/obsidian-git/commit/20e0aba46fa3454f8dabc60dd9d3c579efc322ee)), closes [#564](https://github.com/rudironsoni/obsidian-git/issues/564)
* show missing repo message ([70a6464](https://github.com/rudironsoni/obsidian-git/commit/70a64640f3b21fe61bbdaf0b6215d2878df732be))
* show pulled files when pulled via command ([9022917](https://github.com/rudironsoni/obsidian-git/commit/90229171334d9b25c8631a993da894e8f56ae18d))
* show refs above log message ([4baf55b](https://github.com/rudironsoni/obsidian-git/commit/4baf55b2d264d96071eb16ff6cac92a3a1c6980f))
* show renamed files ([b76c783](https://github.com/rudironsoni/obsidian-git/commit/b76c78332978dbbf7045f94295ed3228de7132a9)), closes [#226](https://github.com/rudironsoni/obsidian-git/issues/226)
* show signs for new hunks on refresh ([491784d](https://github.com/rudironsoni/obsidian-git/commit/491784d381528c4f168da2399d7327c37e55479f))
* show tooltip for topdelete ([adae383](https://github.com/rudironsoni/obsidian-git/commit/adae383b0d661389d1e357a3e435d40f7025b939))
* show/hide settings depending on gitmanager instance ([8f28de8](https://github.com/rudironsoni/obsidian-git/commit/8f28de831af68f5bac385e12b39d1050ccb2c833))
* **simpleGit:** use OS-specific path delimiter for PATH env variable ([#1121](https://github.com/rudironsoni/obsidian-git/issues/1121)) ([9d3bab9](https://github.com/rudironsoni/obsidian-git/commit/9d3bab9e1fd3732095b3abfd1f160baeedf7f5d5))
* simplify can push ([897054f](https://github.com/rudironsoni/obsidian-git/commit/897054fe03df1ce114a97069e4af22430e035cf9))
* small fixes ([b90eeb8](https://github.com/rudironsoni/obsidian-git/commit/b90eeb8229620f2d613b6816212709ce1b87a199))
* some ssh askpass fixes ([b89d095](https://github.com/rudironsoni/obsidian-git/commit/b89d095a2b8a2b6ef943772c0d54602be74e6229)), closes [#994](https://github.com/rudironsoni/obsidian-git/issues/994)
* stage filenames with leading '-' ([c06296e](https://github.com/rudironsoni/obsidian-git/commit/c06296e364962474299687e941fcdab8e03c9061)), closes [#184](https://github.com/rudironsoni/obsidian-git/issues/184)
* stage files in vault below git root ([9d3c662](https://github.com/rudironsoni/obsidian-git/commit/9d3c6620f32b392935a689a9ff645aa664f49478)), closes [#172](https://github.com/rudironsoni/obsidian-git/issues/172)
* stage files without glob pattern ([99b1f6c](https://github.com/rudironsoni/obsidian-git/commit/99b1f6c3d61e4b2fca274531fa98359af0a8c64e)), closes [#196](https://github.com/rudironsoni/obsidian-git/issues/196)
* stage folders ([b320ecd](https://github.com/rudironsoni/obsidian-git/commit/b320ecdfe1182d0cc671153808b385662c78c807))
* stage individual file ([76e317b](https://github.com/rudironsoni/obsidian-git/commit/76e317b5320b3a7e9ab303b402518f3791333a8d))
* staging ([c725082](https://github.com/rudironsoni/obsidian-git/commit/c725082ef9c2f878c9e10102afd95e0f8d0b15a3))
* statusMessage of http request ([7c2d080](https://github.com/rudironsoni/obsidian-git/commit/7c2d080baf7e70c67adacefc62b9be3288e146da))
* store unimportant line author data in localstorage ([9c3f710](https://github.com/rudironsoni/obsidian-git/commit/9c3f710aa864e396864ab1a8f147544d876921df)), closes [#1075](https://github.com/rudironsoni/obsidian-git/issues/1075)
* store username in localstorage ([f3668ac](https://github.com/rudironsoni/obsidian-git/commit/f3668ac23f13d263e50b7d6b716d91150a11b6c7))
* storing lastAutos in a file caused many problems ([2812d94](https://github.com/rudironsoni/obsidian-git/commit/2812d948f0c6b0534c507425249c93397f71e973)), closes [#90](https://github.com/rudironsoni/obsidian-git/issues/90) [#78](https://github.com/rudironsoni/obsidian-git/issues/78)
* storing of last auto backup/pull caused merge conflicts ([cf6f279](https://github.com/rudironsoni/obsidian-git/commit/cf6f27900d05eb3ffe74222950cd00270879fd6c)), closes [#74](https://github.com/rudironsoni/obsidian-git/issues/74)
* strip files list after 500 entries in source control view ([fe1aedb](https://github.com/rudironsoni/obsidian-git/commit/fe1aedb0a12d4e0b5d4a81821a8d08c1417dd6b8))
* sum folder paths in n depth ([e690164](https://github.com/rudironsoni/obsidian-git/commit/e690164c0ef6bc1749008357299f92b9a244d960))
* support vault in subdirectory of git repo ([#722](https://github.com/rudironsoni/obsidian-git/issues/722)) ([171693f](https://github.com/rudironsoni/obsidian-git/commit/171693f7fda542f4ba0452a54979d92c8ecfcdb6))
* textarea for commit message in settings ([ea4a7a1](https://github.com/rudironsoni/obsidian-git/commit/ea4a7a105a8a954e705b372dac127fa3a83fddc1))
* too many changes to display ([c4bf4eb](https://github.com/rudironsoni/obsidian-git/commit/c4bf4eb8bd7d3e9110b354910eed9e29bafbafa6))
* tooltip direction ([#600](https://github.com/rudironsoni/obsidian-git/issues/600)) ([a913303](https://github.com/rudironsoni/obsidian-git/commit/a91330381e83cfc2ece14186325b129d7fc9b6bf))
* trigger vault backup after edit on file rename ([d1ad3d4](https://github.com/rudironsoni/obsidian-git/commit/d1ad3d49a116db03c926df26044e181f9a53a3a0)), closes [#765](https://github.com/rudironsoni/obsidian-git/issues/765)
* trim git object result ([0f3d368](https://github.com/rudironsoni/obsidian-git/commit/0f3d368fea440f4a703ea8db21798c2af6d64557))
* typo in settings ([1e6c3dd](https://github.com/rudironsoni/obsidian-git/commit/1e6c3dddae7f5cd3b8393f36817fba94ed3cd12d))
* typo in settings ([4014057](https://github.com/rudironsoni/obsidian-git/commit/4014057879d24cb176a2ee1baac868fab05bc856)), closes [#468](https://github.com/rudironsoni/obsidian-git/issues/468)
* ui alignment ([a9adfff](https://github.com/rudironsoni/obsidian-git/commit/a9adfff996d570f8e893a2e2786059d0fa2e1cb9))
* unset config on empty value ([d0f927e](https://github.com/rudironsoni/obsidian-git/commit/d0f927ecec9aeeae4ee86873511a208bf943e29c))
* unstage all ([2ff83d3](https://github.com/rudironsoni/obsidian-git/commit/2ff83d3bba5db2f16d2c4719ea73194d8a0357f7))
* unstage all on "None" sync method ([f60f95c](https://github.com/rudironsoni/obsidian-git/commit/f60f95c2a3b8254945cac27913926a62a28c6347))
* unstage all on mobile ([4507fdb](https://github.com/rudironsoni/obsidian-git/commit/4507fdb9c6f2f5c890198a18980586d892786d0e))
* unstage dir ([3d421b7](https://github.com/rudironsoni/obsidian-git/commit/3d421b70e0611b5dbbd91c23668e8b98df57116a))
* unstage folder on desktop ([56afe51](https://github.com/rudironsoni/obsidian-git/commit/56afe510ade79fab52a8a1aa2a9c15739d16a904))
* update changes status bar when focusing different view ([d8cc709](https://github.com/rudironsoni/obsidian-git/commit/d8cc709bf674646216d959ef3c2398f973d5bd3a))
* update settings description ([5e13e49](https://github.com/rudironsoni/obsidian-git/commit/5e13e492118c36beca22b4f138d7ec481a95f3ba))
* update settings grammar ([#656](https://github.com/rudironsoni/obsidian-git/issues/656)) ([d9e8be1](https://github.com/rudironsoni/obsidian-git/commit/d9e8be14b5dbb64a9b78b2d3fe56c474bd57596f))
* update some Notice messages ([a97c44e](https://github.com/rudironsoni/obsidian-git/commit/a97c44e2f5a1581e5bb8ea432deca108df8c7fde))
* update styling ([ebd9734](https://github.com/rudironsoni/obsidian-git/commit/ebd973471ddfa7e267ad85c442a89f9ef2dd1eb1))
* update submodules without outer remote repo ([675cef5](https://github.com/rudironsoni/obsidian-git/commit/675cef52d4e0ebbd2d11ff2322aa21649574bf9d)), closes [#701](https://github.com/rudironsoni/obsidian-git/issues/701)
* use active color for buttons in file component ([c28d44b](https://github.com/rudironsoni/obsidian-git/commit/c28d44b1c6f358cdb0113ebcc4b1634a161dfdf2))
* use correct git dir on mobile ([fd456e5](https://github.com/rudironsoni/obsidian-git/commit/fd456e5f505ba1bedc0ab85fdc62ee9aa91c18e5))
* use correct git implementation ([2def322](https://github.com/rudironsoni/obsidian-git/commit/2def32278a6dadab4777aae38a57821f5d044406)), closes [#387](https://github.com/rudironsoni/obsidian-git/issues/387) [#386](https://github.com/rudironsoni/obsidian-git/issues/386)
* use correct git path on clone on mobile ([686c323](https://github.com/rudironsoni/obsidian-git/commit/686c3230daff6a7fa1d51cf9270295ad975e2599))
* use correct path for diff view via command ([1150351](https://github.com/rudironsoni/obsidian-git/commit/1150351e6bdf066e59cd7579e9efc087d4d5a595)), closes [#397](https://github.com/rudironsoni/obsidian-git/issues/397)
* use correct path with custom base path ([0d86e68](https://github.com/rudironsoni/obsidian-git/commit/0d86e6872fa16c809f7bf71f05e344acaf31008d))
* use correct remote for push on mobile ([7e54350](https://github.com/rudironsoni/obsidian-git/commit/7e5435000116eaefc16826e6747cb5004675efa1))
* use custom git binary path for git check ([7188753](https://github.com/rudironsoni/obsidian-git/commit/718875300f6f9d22e8773a5336bd70b095f63845))
* use custom git path ([5346fc8](https://github.com/rudironsoni/obsidian-git/commit/5346fc8995d11ef46de3277f724bca30aa208a49)), closes [#820](https://github.com/rudironsoni/obsidian-git/issues/820)
* use localstorage for password ([d7c16c6](https://github.com/rudironsoni/obsidian-git/commit/d7c16c68fac414aee58030fd2fd325f066534efc))
* use more specific css class ([471b257](https://github.com/rudironsoni/obsidian-git/commit/471b257671b861f69747882fcd67be22f7dca287))
* use own simple-git fork ([e76f701](https://github.com/rudironsoni/obsidian-git/commit/e76f701e235c3b0a490f3004cbedcaa8fdbe1d8d))
* use proper tree structure on Obsidian 1.3.1 ([c124943](https://github.com/rudironsoni/obsidian-git/commit/c124943d5f1ba388f700524e517a43cf9682abc8)), closes [#512](https://github.com/rudironsoni/obsidian-git/issues/512)
* use queue for actions in source control view ([eb20dd4](https://github.com/rudironsoni/obsidian-git/commit/eb20dd4c93cb6013e9aef1e47f817586261507d5)), closes [#517](https://github.com/rudironsoni/obsidian-git/issues/517)
* use rem instead of px for dimensions ([60e11b7](https://github.com/rudironsoni/obsidian-git/commit/60e11b77ca2a49281d9c79ce45d7a858dfa7a905))
* use setImmediate alternative ([9d29f3f](https://github.com/rudironsoni/obsidian-git/commit/9d29f3fd1041d99e126aabe7d6794356b0e4ac31))
* use timout ([dc7d33a](https://github.com/rudironsoni/obsidian-git/commit/dc7d33a03bcee441bc263bb0bb2365b88ffe70ef))
* **utils:** assign correct stderr variable in spawnAsync error handler ([#1120](https://github.com/rudironsoni/obsidian-git/issues/1120)) ([f075f90](https://github.com/rudironsoni/obsidian-git/commit/f075f90957797184e3ddefbb8dd48a3336700b66))
* Version History Diff for empty base path ([3b9b699](https://github.com/rudironsoni/obsidian-git/commit/3b9b69938d97c1a257755a4896857fe8ee8db557)), closes [#263](https://github.com/rudironsoni/obsidian-git/issues/263)
* walkentry can be null ([3aae1f3](https://github.com/rudironsoni/obsidian-git/commit/3aae1f3b82b6cb1138753cabbe9d60e972741318))
* watch for non Obsidian files on desktop as well ([3155bd0](https://github.com/rudironsoni/obsidian-git/commit/3155bd070f5f780065a55f7773ffb0fd9bc9e7a1)), closes [#1088](https://github.com/rudironsoni/obsidian-git/issues/1088)
* wrap buttons in source control view ([932b7a0](https://github.com/rudironsoni/obsidian-git/commit/932b7a0b617b4f09d70fa7f48072e13ecd5f7f05)), closes [#1011](https://github.com/rudironsoni/obsidian-git/issues/1011)
* wrap tooltip for long paths ([1fc4c1f](https://github.com/rudironsoni/obsidian-git/commit/1fc4c1fd7afbdbb08d7e3a061dd5d602e6f195a3))
