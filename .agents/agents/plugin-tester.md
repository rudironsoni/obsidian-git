---
name: plugin-tester
description: Local quality-gate orchestrator for obsidian-git. Use this subagent to run pnpm checks and focused Vitest suites for WasmGit, UI, and editor changes. There is no real-Obsidian GUI harness in this repository.
---
